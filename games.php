                        ...
                        <div class="right-col-3 floating-left">
                            <div class="books-main-container-page clear-both">
                                ...
                                <div class="ui-panels-worksheet">
                                    ...
                                    $sql = "Select media.*,categories.name_ar, categories.name_en From media Inner Join categories On media.category = categories.catid Where media.status = 1 And media.id > 0 And (media.type=11 OR media.type=12 OR media.type=13) " . $keyword_filter . $cat_filter . $lang_filter . $age_filter . $grade_filter . "  ORDER BY `media`.`price` ASC,  `media`.`id` DESC ,`media`.`is_playlist` DESC";
