...
//    $_SESSION["payment"]["GrandTotal"];
    ...
    $amount->setTotal($_SESSION["subscribe_data"]["total"]+$_SESSION["subscribe_data"]["donate"]);
    ...
    $_SESSION["shipping_info"]["payment_option"]="paypal";
    savePaymentsubscribeToDB($payment);
   ...
   // header("location:".SITE_URL.$lang_code."/purchased?success=1");
    ...
    // NOTE: PLEASE DO NOT USE RESULTPRINTER CLASS IN YOUR ORIGINAL CODE. FOR SAMPLE ONLY
    header("location:".SITE_URL.$lang_code."/pay");
