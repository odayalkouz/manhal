...
<script>
    ...
    $(window).load(function () {
        ...
        $(".jq_addsquare").click(function () {
            ...
            $(".drop-item-container").append('<div data="'+i+'" class="drop-item" style="width: 17.376%;margin-left: 3%"><a class="jq_removesquare" title="Delete"></a><span class="jq_editable" data="'+i+'" contenteditable="true"></span></div>');
    ...
    function loadQuestion(e){
        ...
        for(i=0;i<data['drag'].length;i++){
            $(".drop-item-container").append('<div data="'+data['drag'][i]['type']+'" class="drop-item" style="width: 17.376%;margin-left: 3%"><a class="jq_removesquare" title="Delete"></a><span class="jq_editable" data="'+data['drag'][i]['type']+'" contenteditable="true">'+data['drag'][i]['img']+'</span></div>');
        }
        setTimeout(function () {
