    ...
    for(var i=0;i<shuffleList2.length;i++){
        if(shuffleList2[i].card1.imgShow=="true" || shuffleList2[i].card1.imgShow==true){
            html1+='<div class="card cardClick  card-row'+(i+1)+'"  data="'+shuffleList2[i].type+'"><div class="tool-container"><a class="jq_remove_row"></a><div class="upload_container"><i></i><input type="file" class="jq_upload_img"  onchange="readURL(this);"></input></div><a class="jq_remove_img" style="display: block"></a></div><div class="image-container" cat="'+shuffleList2[i].card1.cat+'"><img imgShow="'+shuffleList2[i].card1.imgShow+'" src="'+shuffleList2[i].card1.imag+'"></div>' +
                '<div class="img-title"><span contenteditable="true">'+shuffleList2[i].card1.title+'</span></div><div class="inner-card" ><span class="textSpan" contenteditable="true">'+shuffleList2[i].card1.text+'</span></div></div>';
        }else {
            html1+='<div class="card cardClick  card-row'+(i+1)+'"  data="'+shuffleList2[i].type+'"><div class="tool-container"><a class="jq_remove_row"></a><div class="upload_container"><i></i><input type="file" class="jq_upload_img"  onchange="readURL(this);"></input></div><a class="jq_remove_img"></a></div><div class="image-container" cat="'+shuffleList2[i].card1.cat+'"><img imgShow="'+shuffleList2[i].card1.imgShow+'" src="'+shuffleList2[i].card1.imag+'"></div>' +
                '<div class="img-title"><span contenteditable="true">'+shuffleList2[i].card1.title+'</span></div><div class="inner-card" ><span class="textSpan" contenteditable="true">'+shuffleList2[i].card1.text+'</span></div></div>';
        }
        if(shuffleList2[i].card2.imgShow=="true" || shuffleList2[i].card2.imgShow==true){
            html2+='<div class="card cardClick card-row'+(i+1)+'"  data="'+shuffleList2[i].type+'"><div class="tool-container"><div class="upload_container"><i></i><input type="file" class="jq_upload_img" onchange="readURL(this);"></input></div><a class="jq_remove_img" style="display: block"></a></div><div class="image-container" cat="'+shuffleList2[i].card2.cat+'"><img imgShow="'+shuffleList2[i].card2.imgShow+'" src="'+shuffleList2[i].card2.imag+'"></div>' +
                '<div class="img-title"><span contenteditable="true">'+shuffleList2[i].card2.title+'</span></div><div class="inner-card" ><span contenteditable="true" class="textSpan">'+shuffleList2[i].card2.text+'</span></div></div>';
        }else {
            html2+='<div class="card cardClick card-row'+(i+1)+'" data="'+shuffleList2[i].type+'"><div class="tool-container"><div class="upload_container"><i></i><input type="file" class="jq_upload_img" onchange="readURL(this);"></input></div><a class="jq_remove_img"></a></div><div class="image-container" cat="'+shuffleList2[i].card2.cat+'"><img imgShow="'+shuffleList2[i].card2.imgShow+'" src="'+shuffleList2[i].card2.imag+'"></div>' +
                '<div class="img-title"><span contenteditable="true">'+shuffleList2[i].card2.title+'</span></div><div class="inner-card" ><span contenteditable="true" class="textSpan">'+shuffleList2[i].card2.text+'</span></div></div>';
        }
