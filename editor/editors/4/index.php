...
<script>
    ...
    $(window).load(function () {
        ...
        $(document).on("click",".jq_addanswer",function () {
            $(".drag-container").append('<div class="drag-item" onclick="selectItem(this)"><a class="jq_deleteanswer"></a><span data="0" class="jq_editable" contenteditable="true">اجابة</span></div>');
        });
    ...
    function loadQuestion(e){
        ...
        $(".drag-container").html('');
        $(".drag-container").append('<div class="drag-item jq_true" onclick="selectItem(this)"><div class="trueanswer"></div><span data="1" class="jq_editable">'+data['correct'][0]['word']+'</span></div>');
        for(i=0;i<data['incorrect'].length;i++){
            $(".drag-container").append('<div class="drag-item" onclick="selectItem(this)"><a class="jq_deleteanswer"></a><span data="0" class="jq_editable">'+data['incorrect'][i]['word']+'</span></div>');
        }
    }
