...
<script>
    ...
    window.defaultItem=JSON.stringify({
        mainTitle:'Choose the correct answer in the following:',
        image:'Why do I have to wear sunglasses?',
        correct:[{word:"So that the sun doesn’t hurt your eyes.",type:"1"}],
        incorrect:[{word:"So that you don’t get hurt.",type:"0"},{word:"So that you fit in.",type:"0"}],
        title:"السؤال الثالث"
    });
    ...
    $(window).load(function () {
        ...
        $(document).on("click",".jq_addanswer",function () {
            $(".drag-container").append('<div class="drag-item" ><a class="jq_deleteanswer"></a><span data="0" class="jq_editable" contenteditable="true">Answer</span></div>');
        });
