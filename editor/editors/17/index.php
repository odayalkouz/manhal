...
<script>
    ...
    function readURL(input)
    {
        if (input.files && input.files[0])
        {
            ...
            reader.onload = function (e) {
                ...
                resizedataURL(e.target.result, 231, 129,input);
                // $("#"+id).attr("updated","1");
            }
            ...
            $.ajax({
                ...
                success: function (jsonData) {
                    ...
                    if(jsonData.status==1){
                        ...
                        $(id).closest(".card").find(".image-container").show();
                        if($(id).closest(".col2")){
                            $(id).closest(".card").find(".inner-card").css({"width":"55%","right":"auto"});
                        }
                    }else{
    ...
    function saveGame() {
        ...
        for(var i=0;i<$(".col1 .card").length;i++){
            ...
            // }
            itemList[i]={card1:{imag:$(".col1 .card .image-container img").eq(i).attr("src"),title:$(".col1 .card .img-title span").eq(i).html(),cat:'1',imgShow:$(".col1 .card .image-container img").eq(i).attr("imgShow")},
                         card2:{text:$(".col2 .card .inner-card span").eq(i).html(),cat:'0'},
                         type:(i+1).toString()
        }}
    ...
    var itemList=[
        {
            card1:{imag:"images/im01.svg",title:"صَباحُ الْخَيْر",cat:'1',imgShow:true},
            card2:{text:"صَباحُ الْخَيْر" ,cat:'0'},
            type:'1',
        },
        {
            card1:{imag:"images/im02.svg",title:"خُطوطُ الْمُشاة",cat:'1',imgShow:true},
            card2:{text:"خُطوطُ الْمُشاة",cat:'0'},
            type:'2',
        },
        {
            card1:{imag:"images/im03.svg",title:"إِشارَةُ الْمُرور",cat:'1',imgShow:true},
            card2:{text:"إِشارَةُ الْمُرور",cat:'0'},
            type:'3',
        },
        {
            card1:{imag:"images/im04.svg",title:"حافِلَةُ الْمَدْرَسَة",cat:'1',imgShow:true},
            card2:{text:"حافِلَةُ الْمَدْرَسَة",cat:'0'},
            type:'4',
        }
    ...
    $(document).on("click", ".jq_add_row", function () {
        ...
        $('<div class="card cardClick card-row'+(cardlength+1)+'" data="'+(cardlength+1)+'"><div class="tool-container"><a class="jq_remove_row"></a><div class="upload_container"><i></i><input type="file" class="jq_upload_img" onchange="readURL(this);"></input></div><a class="jq_remove_img"></a></div><div class="image-container" cat=""><img src="images/1.svg"></div>' +
            '<div class="img-title"><span contenteditable="true">اكتب هنا</span></div></div>').appendTo(".col1");
        $('<div class="card cardClick card-row'+(cardlength+1)+'" data="'+(cardlength+1)+'"><div class="tool-container"></div>' +
            '<div class="inner-card"><span class="textSpan" contenteditable="true">اكتب هنا</span></div></div>').appendTo(".col2");
    ...
    $(document).on('click','.jq_remove_img',function () {
        ...
        if($(this).closest(".col2")){
            $(this).closest(".card").find(".inner-card").css({"width":"100%","right":"0"});
        }
        $(this).hide();
    })
