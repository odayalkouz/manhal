...
function choseCorrect(obj) {
    ...
    if(selectNum==1 && $(obj).hasClass("selected")){
        ...
        $(obj).find(".inner-card").css("background","transparent");
        ...
        $(obj).find(".inner-card").css("background",$(obj).find(".inner-card").attr("bk"));
        $(obj).attr("click","1");
    }
        ...
        if(selct1==selct2){
            $(".cardClick").each(function () {
                if($(this).hasClass("selected")){
                    $(this).css({"border-color":$(this).attr("bk"),"border-width":"2px"});
            ...
            $(".cardClick").each(function () {
                if($(this).hasClass("selected")){
                    ...
                    $(this).find(".inner-card").css("background","transparent");
                    $(this).removeClass("selected");
                }
            })
