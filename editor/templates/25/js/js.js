/**
 * Created by osaid zalloum on 30/19/2021.
 */
...
function choseCorrect(obj) {
    ...
    if(selectNum==1 && $(obj).hasClass("selected")){
        ...
        selct2="";
        selectNum=0;
        $(obj).removeClass("selected").css({"background-image":"url(images/normal.svg)","pointer-events":"auto"});
    }else {
        selectNum++;
        soundEffect("sounds/click.mp3");
        $(obj).addClass("selected");
        $(obj).css("background-image","url("+ $(obj).attr("bk")+")");
    }
        ...
        if(selct1==selct2){
            $(".card").each(function () {
                if($(this).hasClass("selected")){
                    $(this).css("background-image","url("+ $(this).attr("bk")+")");
            ...
            $(".card").each(function () {
                if($(this).hasClass("selected")){
                    $(this).css({"background-image":"url(images/normal.svg)","pointer-events":"auto"});
                    $(this).removeClass("selected");
                }
            })
