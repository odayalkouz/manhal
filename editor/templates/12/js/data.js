 ...
 */
var itemList=[
    {word:"أَنْجَزَتْ جَنى واجِباتِها الْمَدْرَسِيَّةِ بِإِتْقانٍ في الْوَقْتِ الذي وَعَدَتْ بِهِ مُعَلِّمَتَها.",type:"1",true:'صح',false:'خطأ'},
    {word:"اشْتَرَكَ قَيْسٌ في إِحْداثِ الْفَوْضى في الصَّفِّ، ثُمَّ أَنْكَرَ ذلِكَ.",type:"0",true:'صح',false:'خطأ'},
    {word:"اسْتَوْدَعَتْ مَها أُخْتَها سِرًا، فَأَذاعَتْهُ.",type:"0",true:'صح',false:'خطأ'},
    {word:"شَهِدَ سَميرٌ بِشَيءٍ لا يَعْرِفُهُ إِرْضاءً لِصَديقِهِ سَعيدٍ.",type:"0",true:'صح',false:'خطأ'}
];
...
function drawlistArray() {
    ...
    if(itemSelct.length==4){
        ...
        $(".text-inner-container").css("top","21.047%");
    }else if(itemSelct.length==2){
        $(".text-inner-container").css("top","35.047%");
    }
...
function drawItem(){
    ...
    for(var i=0;i<itemSelct.length;i++){
        html+='<div class="text-container" data="'+itemSelct[i].type+'">' +
              ...
              '<div class="trueFalse">' +
              '<a class="true-btn" data="1" onclick="choseCorrect(this)"><span>'+itemSelct[i].true+'</span></a>' +
              '<a class="false-btn" data="0" onclick="choseCorrect(this)"><span>'+itemSelct[i].false+'</span></a>' +
              '</div>' +
              '</div>'
    }
