...
function drawItem() {
    ...
    for(var i=0;i<shuffleList2.length;i++){
        if(shuffleList2[i].card1.imgShow=="true" || shuffleList2[i].card1.imgShow==true){
            html1+='<div onclick="choseCorrect(this)" class="card cardClick" bk="'+shuffleList4[i].borderColor+'" data="'+shuffleList2[i].type+'"><div class="image-container" cat="'+shuffleList2[i].card1.cat+'"><img src="'+shuffleList2[i].card1.imag+'"></div>' +
        ...
        if(shuffleList2[i].card2.imgShow=="true" || shuffleList2[i].card2.imgShow==true){
            html2+='<div onclick="choseCorrect(this)" class="card cardClick" bk="'+shuffleList4[i].borderColor+'" data="'+shuffleList2[i].type+'"><div class="image-container" cat="'+shuffleList2[i].card2.cat+'"><img src="'+shuffleList2[i].card2.imag+'"></div>' +
