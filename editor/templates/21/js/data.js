...
var itemList=[
    ...
    {
        image:"Make sure to use water sparingly.",
        drag:[{word:"sparingly.",type:'2.1'}],
        dropSiz:[{w:'9.3%',h:'42.9%',t:'35.2%',r:'32%',type:'2.1'}]
    },
    {
        image:"A person has to preserve his environment.",
        drag:[{word:"preserve",type:'1.1'}],
        dropSiz:[{w:'9.6%',h:'46%',t:'31%',r:'29.2%',type:'3.1'}]
    },
    {
        image:"You have to accompany the good guys.",
        drag:[{word:"accompany",type:'4.1'}],
        dropSiz:[{w:'12.8%',h:'50%',t:'31.9%',r:'20.9%',type:'4.1'}]
    },
];
var wordList=[
    {word:'advise',type:'1'},
    {word:'sparingly',type:'2'},
    {word:'preserve',type:'3'},
    {word:'accompany',type:'4'},
];
