...
function choseCorrect(obj) {
    ...
    if(selectNum==1 && $(obj).hasClass("selected")){
        ...
        selct2="";
        selectNum=0;
        $(obj).removeClass("selected").css({"background":"#fff","border-color":"var(--bghader3)","pointer-events":"auto"});
    }else {
        selectNum++;
        soundEffect("sounds/click.mp3");
        $(obj).addClass("selected");
        $(obj).css({"background":$(obj).attr("bk"),"border-color":$(obj).attr("borderbg")});
    }
    ...
    if(selectNum==2){
        ...
        if(selct1==selct2){
            ...
            $(".card").each(function () {
                if($(this).hasClass("selected")){
                    $(this).css({"background":"#fff","border-color":"var(--bghader3)","pointer-events":"auto"});
                    $(this).removeClass("selected");
                }
            })
