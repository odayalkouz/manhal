...
$(document).ready(function () {
    ...
    function sectionHeight()
    {
        ...
        $("header .bottom-header-container .right-header-container .buy-content-container").css("left", startfromright);
        $("header .buy-content-container,header .after-login-content-container").css("top", headerHeightmain - 3);
        $("header .buy-content-container,header .after-login-content-container1").css("top", headerHeightmain - 3);
        $("header .bottom-header-container .right-header-container .after-login-content-container").css("left", (startfromright + $("header .bottom-header-container .right-header-container .sign-container").width()) - $(".after-login-container").width() - 20);
        $("header .bottom-header-container .right-header-container .after-login-content-container1").css("left", startfromright+$(".buy-button").width()+15);
        $("header .bottom-header-container .right-header-container .ddl-container-a-content-container").css("left", (startfromright + $("header .bottom-header-container .right-header-container .sign-container a.buy-button").width()) + 12);
        //**********************end sub menu top************************//
        //**********************start back to top***********************//
...
$(function () {
    ...
    var grade = new DropDown($('#favpurch'));
