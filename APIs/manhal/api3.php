...
/*
    ...
    {
        $sql = "Select IF(media.is_story=0,media.id,media.filename) as id, media.*, categories.name_ar, categories.name_en From media Inner Join categories On media.category = categories.catid   where   media.type=" . $type . " and  media.status=1 and media.id=" . $id;
        $result = $this->conn->query($sql);
        return $result;
    }
