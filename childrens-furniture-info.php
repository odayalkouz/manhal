        ...
        <div class="center-piece" style="overflow: visible">
            <div class="inner-container">
                <div class="items-main-container">
                    <div class="display-block-a-info" id="childrens_furniture">
                        <div class="item-container" >
                            <div class="inner-item-container" >
                               <?=$Lang->childrensfurnitureinfoDesc1?>
                               <a href="<?= SITE_URL . $lang_code;?>/childrens-furniture-info">
                               <?=$Lang->childrensfurnitureinfoDesc2?>
                            </div>
                            <div class="note rounded" >
                                <label class="image floating-left"></label>
                                <h2 class="floating-left title"><?=$Lang->daralmanhchildrensfurnitureinformations?></h2>
                            </div>
                        </div>
                    </div>
                </div>
