            ...
            <div class="display-row">
                <div class="display-cell">
                    <div class="image-header-container">
                        <h1><?=$Lang->InteractiveWorksheets;?></h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="center-piece" style="overflow: visible">
            <div class="inner-container">
                <div class="items-main-container">
                    <div class="display-block-a" id="interactive-worksheets">
                        <div class="item-container">
                            <div class="inner-item-container">
                                <?=$Lang->interactiveworksheetsinfoDesc1?>
                                <a href="<?= SITE_URL . $lang_code;?>/worksheet">
                                <?=$Lang->interactiveworksheetsinfoDesc2?>
                            </div>
                            <div class="note rounded" >
                                <label class="image floating-left"></label>
                                <h2 class="floating-left title"><?=$Lang->daralmanhinteractiveworksheetsinfoinformations?></h2>
                            </div>
                        </div>
                    </div>
                </div>
