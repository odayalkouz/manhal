 ...
 */
    ...
    $sql="SELECT `story`.*,`story`.`type` as storytype,`stories_cat`.*,`series`.*,`story`.`rating_count` as rate_count FROM `story` left OUTER JOIN `stories_cat` ON `story`.`catid`=`stories_cat`.`catid` left OUTER JOIN `series` on `story`.`seriesid`=`series`.`seriesid`  WHERE `story`.`status`=1 AND `story`.`storyid`=".$_GET['id'];
    $result = $con->query($sql);
    $row=mysqli_fetch_assoc($result);
    $id=uniqid(rand(10000,99999), true);
    $canRead=getReadingOption("story",$_GET['id']);
    $bg=SITE_URL.'platform/stories/'.$row['seriesid'] . '/story/' . $row['storyid'] . '/images/pic.jpg';
                            ...
                            <div class="rg-thumbs">
                                <div class="es-carousel-wrapper">
                                    <div class="es-carousel">
                                        <ul>
                                            <?php
                                            $path="platform/books/".$row["storyid"]."/screenshoots/";
                                            $thumbs='';
                                            if(is_dir($path)){
                                                $files=scandir($path);
                                                $i=0;
                                ...
                                <div class="top-container-a">
                                        ...
                                        <div class="rating-container floating-left">
                                            ...
                                            <div class="stars floating-right">
                                                <form action="">
                                                    ...
                                                    <input <?= disableRate($row['storyid'], $row, $_GET['type']); ?>
                                                            rate="2"
                                                            bookid="<?= $row['storyid'] ?>" <?= calcRate($row['rate'], 2); ?>
                                                            class="star star-2" id="star-2-<?= $id ?>" prodect="story"
                                                            type="radio" name="star"/>
                                                    <label class="<?= msglogin(disableRate($row['storyid'], $row, $_GET['type'])); ?> star star-2"
                                                           for="star-2-<?= $id ?>"></label>
                                                    <input <?= disableRate($row['storyid'], $row, $_GET['type']); ?>
                                                            rate="1"
                                                            bookid="<?= $row['storyid'] ?>" <?= calcRate($row['rate'], 1); ?>
                                                            class="star star-1" id="star-1-<?= $id ?>" prodect="story"
                                                            type="radio" name="star"/>
                                                    <label class="<?= msglogin(disableRate($row['storyid'], $row, $_GET['type'])); ?> star star-1"
                                                           for="star-1-<?= $id ?>"></label>
                                                    <!-- end khalid 5-9-2016 -->
                                                </form>
                                            </div>
                                    ...
                                    <div class="buttons-container">
                                        ...
                                        <div class="right-button floating-right">
                                            ...
                                            if($detect->isMobile() && !$detect->isTablet()) {
                                                ?>
                                                <a id="view_buy_now" default-qty="<?=$qty;?>" class="floating-right" data-type="story" data-id="<?= $row["storyid"]; ?>"><?= $Lang->BuyNow; ?></a>
                                                <?php
                                            }
                    ...
                    <div class="content-right">
                        ...
                        if(!$detect->isMobile() || $detect->isTablet()) {
                            ...
                            <div class="buttons-container">
                                ...
                                <a id="view_buy_now" default-qty="<?=$qty;?>" data-type="story"
            ...
            <div class="related-content-container">
                <div class="center-piece">
                    <section class="regular slider frame" id="slider">
                        <?php
                        getRelatedProduct($row,"storestory");
                        ?>
...
<!--                                </div>-->
<!--                        </article>-->
<!--                        <article class="item tsc_ribbon_wrap slick-slide slick-current storys-class" style="left: 0px; width: 293px;" data-slick-index="0" aria-hidden="false" tabindex="-1" role="option" aria-describedby="slick-slide00"><div class="inset">-->
<!--                                <div class="inner-items">-->
<!--                                    <a href="http://localhost/Manhal/en/games/1116/Cards Game - Picture and Letter" tabindex="0"></a>-->
<!--                                    <div class="games-item">-->
<!--                                        <a href="http://localhost/Manhal/en/games/1116/Cards Game - Picture and Letter" tabindex="0">-->
<!--                                            <div class="game-thumb" style="background-image: url(https://www.manhal.com/platform/storys/97/cover.jpg)"></div>-->
<!--                                            <div class="game-title">-->
<!--                                                <label>Cards Game - Picture and Letter</label>-->
<!--                                            </div>-->
<!--                                        </a>-->
