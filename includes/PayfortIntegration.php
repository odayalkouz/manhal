...
class PayfortIntegration
{
     ...
     */
    public $merchantIdentifier = 'OjXrZdgn';
    
    /**
     * @var string your access code
     */
    public $accessCode         = '4yosctTk1BwEN9WMXObm';
    
    /**
     * @var string SHA Request passphrase
     */
    public $SHARequestPhrase   = 'dgdgd4564';
    
    /**
     * @var string SHA Response passphrase
     */
    public $SHAResponsePhrase = 'ggj567';
