                            ...
                            <li class="tab-li active">
                                <div class="content__wrapper first-tab-content">
                                    <div class="top-container-a">
                                        ...
                                        $hrf="";
                                       $style='display:none';
                                        $imagevideo='style="background-image:url('.SITE_URL . 'platform/media/' . $row['id'] . '/thumbnail.jpg);background-size: contain; width: 100%; height: 100%;"';
                                        if($row['price']==0 || AreyouPurchased('games', $row['id']) >0){
                                            $hrf=SITE_URL . 'platform/media/' . $row['id'] . '/'.$row['filename'].".mp4?".rand();
                                        ...
                                        <div class="cover-image-container floating-left">
                                            <img src="../platform/media/77/table.png">
                                        </div>
                                        ...
                                        <div class="buttons-container">
                                            ...
                                            <div class="right-button floating-right">
                                                <a data-type="Containersscreenshots" class="with-icon floating-right btn-popup-a" id="show_screenshots" bookid="96"><label class="screenshot"><?=$Lang->ScreenShoots;?></label></a>
                    ...
                    <div class="right-container floating-right">
                        ...
                        <div class="content-right">
                            <ul>
                                ...
                                <li>
                                    <label class="floating-left"><?=$Lang->CompanyName;?>:</label class="floating-left"><span title="<?=$language;?>"><?=$language;?></span>
                                </li>
                            </ul>
                            ...
                            <?php
                            $opengames=false;
                            if($row['price']==0 || AreyouPurchased('video', $row['id']) >0){
                                $opengames=true;
                            }
                            ?>
                            <div class="buttons-container">
