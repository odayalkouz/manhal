        ...
        <div class="center-piece" style="overflow: visible">
            <div class="inner-container">
                <div class="items-main-container">
                    <div class="display-block-a-info" id="worksheets">
                        <div class="item-container">
                            <div class="inner-item-container">
                                <?=$Lang->worksheetsinfoDesc1?>
                                <a href="<?= SITE_URL . $lang_code;?>/worksheet">
                                <?=$Lang->worksheetsinfoDesc2?>
                            </div>
                            <div class="note rounded" >
                                <label class="image floating-left"></label>
                                <h2 class="floating-left title"><?=$Lang->daralmanhworksheetsinfoinformations?></h2>
                            </div>
                        </div>
                    </div>
                </div>
