                    ...
                    <div class="display-block-a-info" id="curricula-requirements">
                        <div class="item-container">
                            <div class="inner-item-container">
                                <?=$Lang->teachersguidesinfoDesc1?>
                                <a href="<?= SITE_URL . $lang_code;?>/teachers-guides">
                                <?=$Lang->teachersguidesinfoDesc2?>
                            </div>
                            <div class="note rounded" >
                                <label class="image floating-left"></label>
                                <h2 class="floating-left title"><?=$Lang->daralmanhteachersguidesinfoinformations?></h2>
                            </div>
                        </div>
                    </div>
                </div>
