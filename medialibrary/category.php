...
?>
    ...
    <div class="panel panel-headline">
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12"><h3 class="page-title m-t-10 m-b-20"><?=$prosses->lang('Category');?></h3></div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <a href="editcategory.php" class="btn-sm shadow-none btn-primary pull-right"><?=$prosses->lang('add');?></a>
                    <a title="Sort" style="margin-right: 10px" class="Sorting btn-sm shadow-none btn-primary pull-right" href="sortcategory.php"><i class="lnr lnr-sort-alpha-asc"></i></a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <th>#</th>
                            <th><?=$prosses->lang('Title_ar');?></th>
                            <th><?=$prosses->lang('Title_en');?></th>
                        ...
                        <tr>
                            ...
                            <td class="actions-container">
                                <a  class="edit" href="editcategory.php" title="<?=$prosses->lang('edit');?>"><i class="lnr lnr-pencil"></i></a>
                                <a class="delete" title="<?=$prosses->lang('delete');?>"><i class="lnr lnr-trash" ></i></a>
                            </td>
                        </tr>
                        </tbody>
                    </table>
