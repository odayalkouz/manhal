        ...
        <div class="center-piece" style="overflow: visible">
            <div class="inner-container">
                <div class="items-main-container">
                    <div class="display-block-a-info" id="estories">
                        <div class="item-container">
                            <div class="inner-item-container">
                                <p class="inner-paragraph">
                                <?=$Lang->electronicstoriesinfoDesc1?>
                                    <a href="<?= SITE_URL . $lang_code;?>/stories">
                                <?=$Lang->electronicstoriesinfoDesc2?>
                                </p>
                            </div>
                            <div class="note rounded">
                                <label class="image floating-left"></label>
                                <h2 class="floating-left title"><?=$Lang->daralmanhalelectronicstoriesinformations?></h2>
                            </div>
                        </div>
                    </div>
                </div>
