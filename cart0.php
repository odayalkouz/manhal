...
<div class="inner-pages-main-container-a cart-main-container">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Hot Offer 50% OFF</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <p class="first">Al-Arabiya Club Level 1 book is usually purchased with the Sonoono Stories series</p>
                    <p class="first">Get the Sonoono Stories series now at a special <b style="color: #eb0c0c">50% discount</b> for one time</p>
                    <!--                        <p>عاده ما يتم شراء كتاب نادي العربيه المستوى الاول مع سلسله قصص السنونو</p>-->
                    <!--                        <p>احصل على سلسله قصص السنونو الان بخصم خاص 50%% لمره واحدة</p>-->
                    <div class="card">
                        <div class="body">
                            <div class="media">
                                <div class="media-left">
                                    <a><img class="media-object" src="<?=SITE_URL;?>themes/main-Light-green-<?=$_SESSION['lang'];?>/images/test.jpg" width="51" height="78"></a>
                                </div>
                                <div class="media-body">
                                    <h4 class="media-heading">سلسلة قصص السنونو</h4>
                                    <div class="about1">
                                        <span class="font-weight-bold current-price " style="float: right">$500</span>
                                        <span class="old-price" style="float: right">$1000</span>
                                        <label class="font-weight-bold sale1 animate-flicker" style="float: right">Sale</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <p class="last">Do you want to add the Sonoono string to the cart ?</p>
                </div>
    ...
    <div class="center-piece">
      ...
      ?>
            ...
            <div class="movings animated <?php if (isset($_SESSION["checkout"]) && $_SESSION["checkout"] == "success") {
                ...
                <div class="cat-container-moving floating-left">
                    <div class="pb-5 mt-n2 mt-md-n3">
                        <div class="row">
                                <div class="col-xl-12 col-md-12 d-sm-flex justify-content-between my-3 pb-3 border-bottom ">
                                    <div class="media d-block d-sm-flex text-center text-sm-left">
                                        <a class="cart-item-thumb mx-auto mr-sm-4" href="#"><img src="http://localhost/Manhal/themes/main-Light-green-En/images/test.jpg" alt="Product"></a>
                                        <div class="media-body pt-2">
                                            <h3 class="product-card-title font-weight-semibold border-0 pb-0"><a href="#">Calvin Klein Jeans Keds</a></h3>
                                            <div class="font-size-sm"><span class="mr-2"><?= $Lang->Category;?>:</span><span class="text-muted mr-2">Arabic</span></div>
                                            <div class="font-size-lg text-muted1 pt-2 ">$25.00</div>
                                        </div>
                                    </div>
                                    <div class="pt-2 pt-sm-0 pl-sm-3 mx-auto mx-sm-0 text-center text-sm-left" style="max-width: 10rem;">
                                        <div class="form-group mb-2">
                                            <label for="quantity1" class="quantity2"><?= $Lang->Quantity; ?></label>
                                            <input class="form-control form-control-sm" type="number" id="quantity1" min="1" value="1">
                                        </div>
                                        <a class="btn btn-sm mb-2 text-right Remove-Item float-right" type="button">Remove Item</a>
                                    </div>
                                </div>
                                <div class="col-xl-12 col-md-12 d-sm-flex justify-content-between my-3 pb-3 border-bottom">
                                    <div class="media d-block d-sm-flex text-center text-sm-left">
                                        <a class="cart-item-thumb mx-auto mr-sm-4" href="#"><img src="https://www.manhal.com/platform/books/209/cover.jpg" alt="Product"></a>
                                        <div class="media-body pt-2">
                                            <h3 class="product-card-title font-weight-semibold border-0 pb-0"><a href="#">Calvin Klein Jeans Keds</a></h3>
                                            <div class="font-size-sm"><span class="mr-2"><?= $Lang->Category;?>:</span><span class="text-muted mr-2">Arabic</span></div>
                                            <div class="font-size-lg text-muted1 pt-2 ">$25</div>
                                        </div>
                                    </div>
                                    <div class="pt-2 pt-sm-0 pl-sm-3 mx-auto mx-sm-0 text-center text-sm-left" style="max-width: 10rem;">
                                        <div class="form-group mb-2">
                                ...
                                <div class="col-xl-12 col-md-12 d-sm-flex justify-content-between my-3 pb-3 border-bottom">
                                    <div class="media d-block d-sm-flex text-center text-sm-left">
                                        <a class="cart-item-thumb mx-auto mr-sm-4" href="#"><img src="https://www.manhal.com/platform/books/97/cover.jpg" alt="Product"></a>
                                        <div class="media-body pt-2">
                                            <h3 class="product-card-title font-weight-semibold border-0 pb-0"><a href="#">Calvin Klein Jeans Keds</a></h3>
                                            <div class="font-size-sm"><span class="mr-2"><?= $Lang->Category; ?>:</span><span class="text-muted mr-2">Arabic</span></div>
                                            <div class="font-size-lg text-muted1 pt-2 ">$25</div>
                                    ...
                                    <div class="pt-2 pt-sm-0 pl-sm-3 mx-auto mx-sm-0 text-center text-sm-left" style="max-width: 10rem;">
                                        <div class="form-group mb-2">
                                            <label for="quantity1" class="quantity2"><?= $Lang->Quantity; ?></label>
                                            <input class="form-control form-control-sm" min="1" type="number" id="quantity1" value="1">
                                        </div>
                                        <a class="btn btn-sm mb-2 text-right Remove-Item float-right" type="button">Remove Item</a>
                                    </div>
                                </div>
                            <div class="col-xl-12 col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-md-6 text-right subTotal1"><?= $Lang->TotalPrice; ?> : $75</div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <a data-toggle="modal" data-target="#exampleModalCenter" class="floating-right button BtnNext   <?php if ((isset($_SESSION["checkout"]) && $_SESSION["checkout"] == "success") || $total_price == 0) {
