...
arrayOfImages=['../../story/st1/images/1.png']
//arrayOfImages=[parent.fillingSrcImage]
arrayOfImagesLoaded=[]
imgCreate=""
...
function DrawImageOnCanvas(){
    ...
    ctxCanvasBackTmpMask.drawImage(arrayOfImagesLoaded[0],0,0,canvas1.width,canvas1.height)
    ...
    ctxFill.drawImage(arrayOfImagesLoaded[0],0,0,canvas1.width,canvas1.height)
    ctxFill1.drawImage(arrayOfImagesLoaded[0],0,0,canvas1.width,canvas1.height)
