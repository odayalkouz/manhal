    ...
    <div class="center-piece">
        ...
        <ul class="tabs">
            ...
            <?php
                ...
                $tabschool="";
                ?>
                <li class="active"><i class="families"></i><a><?=$Lang->Families1;?></a></li>
                <li class="active"><i class="schools"></i><a><?=$Lang->Schools;?></a></li>
            <?php
            }
            ?>
        ...
        <div class="center-content">
            <div class="left-container floating-left">
                <ul class="tab__content">
                    <li class="tab-li active" style="display: block;">
                        <div class="content__wrapper first-tab-content">
                           <div class="blue-offer-container">
                               ...
                               <div class="item-container">
                                   <div class="title">
                                       <h3 class="floating-left"><?=$Lang->Families1;?></h3>
                                   ...
                                   <div class="user-account-row special">
                            ...
                            <div class="orange-offer-container">
                                ...
                                if(!isset($_GET["type"]) || $_GET["type"]!="upgrade"){
                                    ...
                                    <div class="item-container ">
                                        <!--   <div class="title">
                                            <h3 class="floating-left"><?=$Lang->Schools;?></h3>
                                        ...
                                        <!--<a<?=$datatype?>class=" button-join floating-right <?=$att?>"><?=$Lang->Join;?></a>--!>
                                        <a href="<?= SITE_URL . $lang_code; ?>/imanhal" class=" button-join1 floating-right"><?=$Lang->More;?></a>
                    ...
                    <div class="content-container">
                        <div class="left-container floating-left">
                            ...
                            <ul>
                                ...
                                <li class="floating-left"><i class="floating-left"></i><label class="floating-left"><b style="color: #00a951"><?=$Lang->LearningResourcesm;?></b></label></li>
                            </ul>
                        </div>
