        ...
        <div class="center-piece" style="overflow: visible">
            <div class="inner-container">
                <div class="items-main-container">
                    <div class="display-block-a-info" id="educational_game">
                        <div class="item-container">
                            <div class="inner-item-container" >
                               <?=$Lang->educationalgamesinfoDesc1?>
                               <a href="<?= SITE_URL . $lang_code;?>/games">
                               <?=$Lang->educationalgamesinfoDesc2?>
                            </div>
                            <div class="note rounded">
                                <label class="image floating-left"></label>
                                <h2 class="floating-left title"><?=$Lang->daralmanhaeducationalgamesinformations?></h2>
                            </div>
                        </div>
                    </div>
                </div>
