...
$bredcrumb = '<li class="floating-left"><a href="stories_cat.php" class="floating-left active">' . $Lang->StoriesCategory . '</a></li>';
...
//    print_r($kids);
                ...
                if (isset($category['kids']) && $category['kids'] != null) {
                    ...
                    foreach ($category['kids'] as $key => $kid) {
                        if (array_search($kid['catid'], $temp_arr) === false) {
                            ...
                            echo '<div class="dd-handle dd3-handle "></div><div class="dd3-content">' . $kid['name_' . strtolower($_SESSION["lang"])];
                            ...
                            <ol class="dd-list">
                                ...
                                foreach ($cat as $category) {
                                    if (array_search($category['catid'], $temp_arr) === false) {
                                        ...
                                        echo '<div class="dd-handle dd3-handle"></div><div class="dd3-content">' . $category['name_' . strtolower($_SESSION["lang"])];
                                        echo "<div class='floating-right'><a href='editbrandcat.php?id=" . $category['catid'] . "'><i class='flaticon-pencil43'></i></a><a href='javascript:deletedepartment(" . $category['catid'] . ")' ><i class='flaticon-delete96'></i></a></div></div>";
        ...
        <a href="createcategory.php?type=brand" class="btn-default floating-right"><?= $Lang->AddCategory; ?></a>
