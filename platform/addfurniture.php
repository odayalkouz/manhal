...
$bredcrumb = '<li class="floating-left"><a href="furniture.php" class="floating-left">'.$Lang->Furniture.'</a></li><span class="floating-left">/</span><li class="floating-left"><a href="addfurniture.php" class="floating-left active">'.$Lang->AddFurniture.'</a></li>';
            ...
            <div class="display-inline-block floating-left">
                ...
                <div class="line-row">
                    ...
                    <textarea class="floating-left txt-b" name="mediadescription_ar" id="mediadescription_ar"
                              ...
                              placeholder="<?= $Lang->BookDescriptionAr; ?>"></textarea>
                ...
                <div class="line-row">
                    ...
                    <textarea class="floating-left txt-b" name="mediadescription_en" id="mediadescription_en"
                              ...
                              placeholder="<?= $Lang->BookDescriptionEn; ?>"></textarea>
                ...
                <div class="line-row">
                    ...
                    <textarea class="floating-left txt-b" name="mediadescription_ar" id="mediadescription_ar"
                              ...
                              placeholder="<?= $Lang->SEODescriptionAr; ?>"></textarea>

                </div>
                <div class="line-row">
                    <label class="lbl-data-a floating-left"><?= $Lang->SEODescriptionEn; ?></label>
                    <textarea class="floating-left txt-b" name="mediadescription_en" id="mediadescription_en" placeholder="<?= $Lang->SEODescriptionEn; ?>"></textarea>
                </div>
            </div>
            <div class="display-inline-block floating-left">
                <div class="line-row">
