...
<div class="ContainerEditor">
    <div class="headerEditor">
        <span class="title-editor floating-left">Maze</span>
        <span class="line-title"></span>
        <div class="question-container floating-left">
            <span>Question :</span>
            <input id="question" type="text" placeholder="Enter question text">
        </div>
...
<!--            <div class="separator floating-left"></div>-->
    ...
    <div class="work-area">
        <div class="leftPanelTools" style="display: none">
            <div class="tools-header">
                <span>Tools</span>
            </div>
            <div class="dash-top"></div>
            <a title="Add empty area object." style="display: none" class="btn add-area" onclick="addTransparentLayer()"><i></i></a>
        </div>
        <div id="gameContainer" class="gameContainer" >
            <div class="gameContent" >
                ...
                <div class="add-image-container-1">
                    <span>Add Image</span>
                    <form id="image_maze" style="width:100%;height:100%" enctype="multipart/form-data" method="post" action="image_upload_script.php?imagename=maze" target="hidden_iframe">
                     <input name="URL_" class="add-image URL_" type="hidden"  />
                        <input name="width" value="920" class="Maze_width" type="hidden"  />
                        <input name="height" value="768" class="Maze_height" type="hidden"  />
                ...
                <div class="add-image-container-2">
                    <span>Add Icon</span>
                    <form id="image_face" style="width: 100%;height:100%" enctype="multipart/form-data" method="post" action="image_upload_script.php?imagename=face" target="hidden_iframe">
                        <input name="URL_" class="add-image-1 URL_" type="hidden"  />
                        <input name="width" value="100" class="Face_width" type="hidden"  />
                        <input name="height" value="100" class="Face_height" type="hidden"  />
