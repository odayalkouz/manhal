...
function BookMessage() {
    window.parent.showBookMsg("Excellent","<span style='display: block;font-size: 2vmin;'>The Result</span ><span style='font-size: 2vmin;font-weight: bold;'>100%</span>",window.parent.$('iframe[src="'+window.location.href+'"]').closest(".element").attr("id"));
}
