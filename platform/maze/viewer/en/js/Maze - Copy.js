...
window.onload = function() {
  ...
  drawMaze("../../../games/" + config.id+"/images/maze.png?v="+Date.now(),x1,y1);
...
function drawMaze(mazeFile, startingX, startingY) {
  ...
  imgMaze.onload = function() {
    ...
    canvas.width =920// imgMaze.width;
    canvas.height = 768//imgMaze.height;
...
function checkForCollision() {
  ...
  var imgData = context.getImageData(x-1, y-1, W+2, H+2);
