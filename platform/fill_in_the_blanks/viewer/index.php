...
<head>
    ...
    <script>
        ...
        stringLink +="<link rel='stylesheet' href='<?php if(isset($_GET["lan"])){echo $_GET["lan"];}else{echo 'en';};?>/css/style.css'>";
        ...
        $gameTitl="";
        $wellDone="";
                if(isset($_GET["lan"]) && $_GET["lan"]=="ar"){
                    $gameTitl="املأ الفراغ";
                    $helptitle="التعليمات";
                    $helpText="اقرأ النص وضع البطاقات في مكانها الصحيح.";
                    $wellDone="أحسنت";
                }else{
    ...
    <div class="quiz-wrapper" id="innerGame">
        ...
        <div class="win-container-popup">
            <div class="win-content">
                ...
                <a onclick="javascript:location.reload();" class="replay"></a>
            </div>
        </div>
        <div class="green-title-bg">
            <div class="title-white"><?php echo $gameTitl ;?></div>
        </div>
        <div class="plane"></div>
