<?php
$cuerrentpage = "storedepartment.php";
    ...
    <script>
        $(document).ready(function () {
            $("#save_category").click(function () {
                ...
                $.ajax({
                    url: "ajax/editor.php?process=sortcategoriesdepartment",
                    type: "POST",
                    cache: false,
                    dataType: 'html',
...
//    print_r($kids);
                            ...
                            <ol class="dd-list">
                                ...
                                foreach ($cat as $category) {
                                    if (array_search($category['catid'], $temp_arr) === false) {
                                        ...
                                        echo "<div class='floating-right'><a href='editdepartmentcat.php?id=" . $category['catid'] . "'><i class='flaticon-pencil43'></i></a><a href='javascript:deletedepartment(" . $category['catid'] . ")' ><i class='flaticon-delete96'></i></a></div></div>";
        ...
        <a href="createcategory.php?type=department" class="btn-default floating-right"><?= $Lang->AddCategory; ?></a>
