        ...
        $(document).ready(function () {
            ...
            $("#save_category").click(function(){
                ...
                $(".dd-item").each(function(){
                    ...
                    $.ajax({
                        url: "ajax/editor.php?process=sortcategoriesstory",
                        type: "POST",
                        cache: false,
                        dataType: 'html',
...
//                var popID = conID.replace("Container", "Popup");
...
function getKids($category){
    ...
    if(isset($category['kids']) && $category['kids']!=null){
        ...
        echo '</ol>';
            ...
            $sql = "SELECT * FROM `stories_cat` ORDER BY `parent`";
            ...
            <div class="sortable-main-container" style="display: inline-block;overflow:hidden;margin: 0 auto; width: 100%">
                ...
                foreach($cat as $category){
                    if(array_search($category['catid'],$temp_arr)===false){
                        ...
                        echo "<div class='floating-right'><a href='editcategory.php?id=" . $category['catid'] . "'><i class='flaticon-pencil43'></i></a><a href='javascript:deletecategorystory(" . $category['catid'] . ")' ><i class='flaticon-delete96'></i></a></div></div>";
        ...
        <a href="createcategory.php?type=stories" class="btn-default floating-right"><?= $Lang->AddCategory; ?></a>
        <a href="#" id="save_category" class="btn  btn-default floating-right"><?= $Lang->View; ?></a>
    </div>
