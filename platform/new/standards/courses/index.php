            ...
            <div class="card-body ">
                <div class="row">
                    <div class="col-lg-10 float-right m-b-10">
                        <h5 class="card-title text-left"><?=$Lang->Courses;?></h5>
                    </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="icons-actions units-row units-contract" href="units.php" title="<?=$Lang->Units;?>"><i class="metismenu-icon pe-7s-network"></i></a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
