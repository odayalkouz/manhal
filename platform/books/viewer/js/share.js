...
a2a_config.vars = {
    vars: ["menu_type", "static_server", "linkname", "linkurl", "linkname_escape", ["ssl", (document.location.protocol != "http:") ? "https://static.addtoany.com/menu" : false], "show_title", "onclick", "num_services", "hide_embeds", "prioritize", "exclude_services", "custom_services", ["templates", {}], "orientation", ["track_links", false], ["track_links_key", ""], "awesm", "tracking_callback", "track_pub", "color_main", "color_bg", "color_border", "color_link_text", "color_link_text_hover", "color_arrow", "color_arrow_hover", ["localize", "", 1], ["add_services", false, 1], "locale", "delay", "icon_color", "no_3p", "show_menu", "target"],
    process: function () {
...
var a2a = a2a || {
        ...
        fn_queue: [],
        dom: {
            isReady: false, ready: function (c) {
                var h = function () {
                    if (!document.body) {
        ...
        init: function (b, a, f) {
            var d = a2a.c, a = a || {}, n = {}, m = null, e, c = {}, h, j, i, k, g = location.href,
                l = function (p, q) {
                    a2a.total++;
                    a2a.n = a2a.total;
                    a2a["n" + a2a.n] = p;
                    var o = p.node = a2a.set_this_index(p.node), s = document.createElement("div"), v, u,
                        t = a2a.getData(o)["a2a-title"], r = a2a.getData(o)["a2a-url"];
                    if (!o) {
                        if (!a2a.c.show_menu) {
                            a2a.total--
                        }
        ...
        button: function (d) {
            var c = d.node, g = d.type, b = a2a.gEl("a2a" + g + "_dropdown"), a = "mousedown", f = "mouseup", e;
        ...
        kit: function (r, k) {
            var ae = a2a.type, j = {
                    behance: {name: "Behance", icon: "behance", url: "https://www.behance.net/${id}"},
                    facebook: {name: "Facebook", icon: "facebook", url: "https://www.facebook.com/${id}"},
                    flickr: {name: "Flickr", icon: "flickr", url: "https://www.flickr.com/photos/${id}"},
                    foursquare: {name: "Foursquare", icon: "foursquare", url: "https://foursquare.com/${id}"},
                    github: {name: "GitHub", icon: "github", url: "https://github.com/${id}"},
                    google_plus: {name: "Google+", icon: "google_plus", url: "https://plus.google.com/${id}"},
                    instagram: {name: "Instagram", icon: "instagram", url: "https://www.instagram.com/${id}"},
                    linkedin: {name: "LinkedIn", icon: "linkedin", url: "https://www.linkedin.com/in/${id}"},
                    linkedin_company: {name: "LinkedIn", icon: "linkedin", url: "https://www.linkedin.com/company/${id}"},
                    pinterest: {name: "Pinterest", icon: "pinterest", url: "https://www.pinterest.com/${id}"},
                    tumblr: {name: "Tumblr", icon: "tumblr", url: "http://${id}.tumblr.com"},
                    twitter: {name: "Twitter", icon: "twitter", url: "https://twitter.com/${id}"},
                    vimeo: {name: "Vimeo", icon: "vimeo", url: "https://vimeo.com/${id}"},
                    youtube: {name: "YouTube", icon: "youtube", url: "https://www.youtube.com/user/${id}"},
                    youtube_channel: {
                ...
                u = ["facebook_like", "twitter_tweet", "google_plusone", "google_plus_share", "pinterest_pin", "linkedin_share"],
                p = a2a.counters.avail, A = function (n, ai) {
                    ...
                    var ag = {node: i, service: ah, title: B, url: t}, n = a2a.cbs("share", ag);
                ...
                }, b = a2a.c.templates, e = r.node, W = a2a.getData(e), ac = e.a2a_follow,
                O = a2a.HTMLcollToArray(e.getElementsByTagName("a")), z = O.length, m = document.createElement("div"),
                s = encodeURIComponent, t = r.linkurl, g = s(r.linkurl).replace(/'/g, "%27"), B = r.linkname,
                l = s(r.linkname).replace(/'/g, "%27"), D = W["a2a-icon-color"] || a2a.c.icon_color,
                F = e.className.match(/a2a_kit_size_([\w\.]+)(?:\s|$)/), R = (F) ? F[1] : false, aa = R + "px",
                I = "a2a_img a2a_i_", X = {}, f = {},
                                ...
                                if (ai && ai.region == "tweet") {
                                    var aj = (function () {
                                        ...
                                        if (an && an.indexOf("url=") > -1) {
                                            var ak = {}, am = an.split("&"), ap = am.length;
            ...
            a2a.kit.pinterest_pin = function () {
                ...
                if (!a2a.kit.pinterest_pin_script) {
                    (function (ag) {
                        var n = ag.createElement("script"), af = ag.getElementsByTagName("script")[0];
            ...
            a2a.kit.linkedin_share = function () {
                ...
                a2a.kit.linkedin_share_event = function () {
                    a2a.GA.track("LinkedIn Share", "linkedin_share", t, "pages", "AddToAny Share/Save Button");
                    H("LinkedIn Share", d)
                };
                if (!a2a.kit.linkedin_share_script) {
                    (function (af) {
                        var i = af.createElement("script"), n = af.getElementsByTagName("script")[0];
                ...
                d.innerHTML = '<script type="IN/Share"' + Q + "><\/script>"
            };
            ...
            for (var Y = 0; Y < z; Y++) {
                var d = O[Y], q = d.className, y = q.match(/a2a_button_([\w\.]+)(?:\s|$)/),
                    c = (q.indexOf("a2a_dd") >= 0), a = (q.indexOf("a2a_counter") >= 0), P = (y) ? y[1] : false,
                    S = d.childNodes, E = A(P), ad = (ac && j[P]) ? j[P].name : E[0], h = "_blank",
                    V = (ac && j[P]) ? j[P].icon : E[1], Z = E[2] || {}, L = Z.type, x = E[3], w = false, N = false, v,
                    K, U, Q = "", J = {};
                if (c) {
                    k.target = d;
                    a2a.init(ae, k, 1);
                ...
                if (!c) {
                    ...
                    if (!ac) {
                        a2a.add_event(d, "click", (function (i, af, ag, n, ah) {
                            return function (ak) {
                                var al = screen.height, am = 550, ai = 450,
                ...
                if (S.length) {
                    for (var ab = 0, T = S.length; ab < T; ab++) {
                        if (S[ab].nodeType == 1 && S[ab].className != "a2a_label") {
                            K = true;
                            break
                        }
                    }
                    ...
                    v.innerHTML = ad || (ae == "feed" ? a2a.c.localize.Subscribe : a2a.c.localize.Share);
                    d.appendChild(v)
                }
                if (G && R && R < 20) {
                    N = false
        ...
        counters: {
            get: function (b, a, g) {
                var d = decodeURIComponent(g), c = a2a.counters[b], f = c.api, j = c.cb, i = a.a2a.is_a2a_dd_counter, h,
                    e;
                h = c[d] = c[d] || {};
                if (h.num) {
                    if (i) {
            ...
            linkedin: {
                api: ["https://www.linkedin.com/countserv/count/share?url="], cb: function (b, a) {
                    if (b && !isNaN(b.count)) {
                        return b.count
                    }
                }
            ...
            pinterest: {
                api: ["https://widgets.pinterest.com/v1/urls/count.json?url="], cb: function (b, a) {
                    if (b && !isNaN(b.count)) {
                        return b.count
                    }
                }
            ...
            reddit: {
                api: ["https://www.reddit.com/api/info.json?url=", "&jsonp"], cb: function (f, d) {
                    var a = f.data;
                    if (f && a && a.children) {
            ...
            tumblr: {
                api: ["https://api.tumblr.com/v2/share/stats?url="], cb: function (b, a) {
            ...
            twitter: {
                api: ["https://cdn.api.twitter.com/1/urls/count.json?url="], cb: function (b, a) {
                    if (b && !isNaN(b.count)) {
                        return b.count
                    }
                }
            ...
            if (document.getElementsByClassName && Object.prototype.getElementsByClassName === document.getElementsByClassName) {
                ...
                if (document.evaluate) {
                    a2a.getByClass = function (o, n, r) {
                        ...
                        var g = o.split(" "), p = "", l = "http://www.w3.org/1999/xhtml",
                            q = (document.documentElement.namespaceURI === l) ? l : null, h = [], d, f;
                    ...
                    a2a.getByClass = function (r, q, u) {
                        ...
                        var h = r.split(" "), t = [], d = (u === "*" && q.all) ? q.all : q.getElementsByTagName(u), p,
                            j = [], o;
        ...
        fast_click: {
            make: function (b, c, a) {
                ...
                this.clickbuster = {
                    coordinates: [], preventGhostClick: function (b, c) {
        ...
        toggle_dropdown: function (a, e) {
            ...
            var b, f = a2a.gEl, i = f("a2a" + e + "_dropdown"), c = f("a2a" + e + "_shim"), d = "mousedown",
                h = "mouseup", g = document.activeElement;
            i.style.display = a;
        ...
        getPos: function (b) {
            ...
            return {left: a(c.left + a2a.getScrollDocDims("w")), top: a(c.top + a2a.getScrollDocDims("h"))}
        },
        ...
        show_more_less: function (b) {
            a2a.onMouseOver_stay();
            var d = a2a.type, e = "a2a" + d, a = a2a.gEl, c = a(e + "_show_more_less");
            a2a.show_full();
            a2a.embeds_fix(true);
            if (b == 0) {
                return false
        ...
        do_find: function () {
            var f = a2a.type, d = a2a[f].main_services, c = d.length, b = a2a.gEl("a2a" + f + "_find").value, g,
                a = a2a.in_array;
            if (b !== "") {
                g = b.split(" ");
                for (var e = 0, h; e < c; e++) {
        ...
        linker: function (t) {
            var n = location.href, o = document.title || n, r = a2a["n" + (t.parentNode.a2a_index || a2a.n)],
                e = r.node, d = r.type, h = a2a.getData(e)["a2a-url"] || r.linkurl,
                b = (r.linkurl_implicit && n != h) ? n : h, i = encodeURIComponent(b).replace(/'/g, "%27"),
                c = a2a.getData(e)["a2a-title"] || r.linkname, j = (r.linkname_implicit && o != c) ? o : c,
                ...
                p = t.a2a.customserviceuri || false, s = t.a2a.safename, q = t.a2a.stype, k = t.a2a.js_src, m,
                a = a2a.c.templates;
            if (q && q == "js" && k) {
                t.target = "";
            ...
            t.href = m || "http://www.addtoany.com/add_to/" + s + "?linkurl=" + i + "&linkname=" + g + l + ((a2a.c.awesm) ? "&linktrack_parent=" + a2a.c.awesm : "") + ((s == "twitter" && a[s]) ? "&template=" + encodeURIComponent(a[s]) : "") + (((s == "email" || q && q == "email") && a.email) ? "&" + a2a.serialize({template: a.email}) : "") + ((d == "feed") ? "&type=feed" : "") + "&linknote=" + f;
            return true
        },
        show_full: function () {
            var g = a2a.type, a = "a2a" + g, h = a2a.gEl, i = a2a.getByClass, b = h(a + "_find"), d = h(a + "_overlay"),
                c = h(a + "_shim"), f = h(a + "_full"), e = i("a2a_full_header", f)[0], k = h(a + "_full_services"),
            ...
            a2a.show_full.key_listener = a2a.add_event(document, "keydown", function (n) {
                var n = n || window.event, m = n.which || n.keyCode, l = document.activeElement;
                if (m == 27 && b != l) {
                    a2a.hide_full(g)
                } else {
                    if (m > 40 && m < 91 && b != l) {
        ...
        hide_full: function (f) {
            var a = a2a.gEl, e = "a2a" + f, d = a(e + "_full"), b = a(e + "_overlay");
        ...
        show_menu: function (p, f) {
            ...
            var q = a2a["n" + a2a.n], h = a2a.type = q.type, e = "a2a" + h, s = a2a.gEl(e + "_dropdown"),
                m = "mousedown", r = "mouseup";
            a2a.gEl(e + "_title").value = q.linkname;
            a2a.toggle_dropdown("block", h);
            var n = [s.clientWidth, s.clientHeight], j = a2a.getDocDims("w"), g = a2a.getDocDims("h"),
                b = a2a.getScrollDocDims("w"), c = a2a.getScrollDocDims("h"), t, a, d, l;
            if (p) {
                    ...
                    if (typeof pageTracker == "object") {
                        ...
                        if (typeof _gaq == "object") {
                            ...
                            if (typeof GoogleAnalyticsObject == "string") {
                                a2a.GA.track = function (i, f, h, e, g) {
                                    if (a != "feed") {
                                        b[GoogleAnalyticsObject]("send", "social", "AddToAny", i, {page: (h || a2a["n" + a2a.n].linkurl)})
                                    }
        ...
        add_services: function () {
            var k = a2a.type, l = a2a.gEl, e = parseInt(a2a[k].num_services), n = l("a2a" + k + "_full_services"),
                a = l("a2a" + k + "_mini_services"), h;
        ...
        util_frame_make: function (f) {
            var h = document.createElement("iframe"), d = document.createElement("div"), e = encodeURIComponent,
                c = (document.referrer) ? e(document.referrer) : "", b = e(location.href), a = e(document.title || ""),
            ...
            h.src = "https://static.addtoany.com/menu/sm13.html#type=" + f + "&event=load&url=" + b + "&referrer=" + c;
            d.style.top = "0";
        ...
        top_services: function (r, c, s) {
            var l = c || a2a.type, p = a2a.in_array, e = a2a.make_service, j = parseInt(a2a[l].num_services),
                b = a2a.gEl("a2a" + l + "_full_services"), q = a2a.gEl("a2a" + l + "_mini_services"),
                a = a2a.getByClass("a2a_i", b, "a"), d = a2a.getByClass("a2a_i", q, "a"), g = [];
            if (r) {
                ...
                if (g.length > 0) {
                    for (var o = 0, s = s, u, h, k; o < g.length; o++) {
                        if (u = p(g[o].a2a.safename, d, true, "a2a", "safename")) {
                            ...
                            h = g[o].a2a;
                            k = e(h.servicename, h.safename, h.serviceIcon, {type: h.serviceType, pu: h.popup})
                        }
                        if (s) {
        ...
        svg_css: function () {
            var a = window, e = a2a.fix_icons, f = ["icons.15.svg.css", "icons.15.png.css", "icons.15.old.css"],
                c = a2a.svg_works(), d = function (i) {
                    var h = a.document.createElement("link"), g = a2a.c.static_server,
        ...
        make_service: function (b, d, k, h, l, e) {
            ...
            a2a.add_event(g, "click", function (o) {
                var m = a2a["n" + a2a.n], p = {node: g, service: b, title: m.linkname, url: m.linkurl},
                    n = a2a.cbs("share", p);
                if (typeof n != "undefined") {
                    if (n.url) {
                        m.linkurl = n.url;
            ...
            a2a.add_event(g, "click", function (m) {
                var p = encodeURIComponent, n = a2a["n" + a2a.n], r = (j == "page") ? "pages" : "subscriptions",
                    o = (j == "page") ? "AddToAny Share/Save Button" : "AddToAny Subscribe Button", q = screen.height,
                    s = 550, u = 450,
...
a2a.make_once = function (c) {
    ...
    if (!a2a[a2a.type] && !window["a2a" + a2a.type + "_init"]) {
        ...
        a2a["create_" + a2a.type + "_dropdown"] = function (O, u) {
            var o = a2a.gEl, s = a2a.type = O, q = "a2a" + s, N = a2a.c, A = a2a.ieo(), y,
                p = document.createElement("i"), m, l, M, F = document.createElement("a"), v = N.icon_color,
                x = (v && a2a.svg_works()) ? "a2a_svg a2a_w__default a2a_w_" : "a2a_svg a2a_s__default a2a_s_",
                C = (v) ? ' style="background-color:' + v + '"' : "", K = N.localize;
            a2a.css();
            K = N.localize = {
                Share: K.Share || "Share",
                Save: K.Save || "Save",
            ...
            n += "</div>";
            var E = "a2a_menu_container", J = o(E) || document.createElement("div");
            ...
            var r = new RegExp("[\\?&]awesm=([^&#]*)"), w = r.exec(window.location.href);
            if (w != null) {
                N.awesm = w[1]
            } else {
                N.awesm = false
