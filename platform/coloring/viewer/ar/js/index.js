...
function normalPen(object) {
    ...
    $('#penselect').css('background-size', '100%')
    $(".gameConainer")
        .removeClass("erazerCursor")
    $(".gameConainer")
        .removeClass("fillCussor")
    $(".gameConainer")
        .addClass("normalBrush")
    console.log("normal")
...
//***********************
    ...
    $( ".color-container" ).addClass("active")
    // $( ".color-container" ).slideUp( "fast", function() {
...
function printCanvas()
{
    ...
    var printWindow = window.open('', 'to_print', 'height=1024,width=1024');
    var html = '<html><head><title></title></head><body style="width: 100%; padding: 0; margin: 0;" ><img src="'+canvas.toDataURL()+'"></body></html>';
...
function choseColor(obgect) {
    var id=$(obgect).attr("colorNum");
    $(".color-plate").fadeOut();
