...
function buildTimer(){
    ...
    ' </div>'+
    '</div>';
    $(str).appendTo(document.getElementById("inner-container"));
...
function TimeOut(){
    ...
    speachSound("sound/timeout.mp3")
    $(document.body).msgBox({

        msgText1: "",
        msgText2: "",
        imgSrc: "../../images/time-out.svg",
    ...
    $("#lbl-data1").css("background-image","url('../../images/lbl-time-a.svg')");
    $("#lbl-data2").css("background-image","url('../../images/lbl-time-b.svg')");
    // $('#messageContainer img').css({"top":"3%","height":"44%","right":"-5%","width":"43%"});
