...
(function ($) {
    ...
    var loadComplete = function () {
        $(".logo-game").fadeIn()
        $(".logo-game").removeClass("animated fadeInDown");
        $(".logo-game").addClass("animated fadeInDown");
        $(jBar).stop().animate({
            width: '99%'
        }, 500, 'linear', function () {
            ...
            // setTimeout(function () {
            //     $(".play").removeClass("animated rotateIn");
            //     $(".play").animate({
            //     }, 1000, function()
            //     {
            //         $(".play").fadeIn();
            //         $(".play").addClass("animated rotateIn");
            //         $(".background-play").addClass("background-play-top");
            //     });
            // },300)
        });
    }
