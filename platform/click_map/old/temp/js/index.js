...
$(document).ready(function () {
    ...
    $(".muteIcon").click(function () {
        if ($(".bgsound").prop('muted')) {
            ...
            $(this).attr('src', "images/mute.png?" + Math.random()); // changing icon for button

        } else {
            $(".bgsound").prop('muted', true);
            $(this).attr('src', "images/unmute.png?" + Math.random());
        }
    });
    ...
    if (game[0].typeEdit == "WithSound" || game[0].typeEdit == "justText") {
        ...
        if (idSound == idImage) {
            ...
            str = '<div class="hintContainer"><div class="hint" >' +
                ...
                '<img class="imgShapes" src="images/' + qustionSoundArray[qustionIndex].imageSrc + '">' +
...
function win() {
    ...
    str = '<div class="hintContainerWin"><div class="hintWin animated rotateIn" >' +
        '<label class="labelWin" >أحسنت , لقد فزت</label><br>' +
        '<label class="labelWin" >نسبة الدقة  في الاجابة ' + accu + '%</label>' +
...
function correctAnswer() {
    ...
    str = '<div class="hintContainerWin"><div class="hintWin animated bounce" >' +
        '<label class="labelWin" >أحسنت , ابحث عن المزيد</label>' +
...
function attempNumbersCheck() {
    if ($(".lifeStar").length <= 0) {
        ...
        str = '<div class="hintContainerWin ">' +
            '<div class="hintWin animated bounce" >' +
            '<label class="labelWin" >لقد استنفذت جميع المحاولات , حاول مرة أخرى</label>' +
            '<img class="imgShapes animated shake" src="images/loser.png">' +
            '<img class="relodeImg" src="images/continue.png" onclick="again()">' +
...
function noTriesME(gameTrie) {
    $(".lifeStar").remove()
str=' <img class="lifeStar" src="images/life.png">'

    for (_i = 0, _len = Number(gameTrie); _i < _len; _i++) {

        $(str).appendTo('.lifeCont')
    }
