...
function showSetting() {
    ...
    str = '<div class="proprties">' +
        ...
        '<input readonly style="margin-top: 9px;width: 406px" class="text-fild-upload floating-left" type="text" value="../games/gamesUser/' + game.backgroundSound + '" id="ObjectSound">' +
