...
var ishideRootLine = false

function hideRootLine() {

    if(ishideRootLine==false){
        object= $(".lines").find("i")
        ishideRootLine=true
        // object.css({
        //     "background-image":"images/showline.png",
        //
        // })
    }else{

        ishideRootLine=false


        // object.css({
        //     "background-image":"images/hideline.png",
        //
        // })
...
function initMatching() {
    ...
    $(".top-tools-container .lines").show();
    $(".matching-tools").show();
