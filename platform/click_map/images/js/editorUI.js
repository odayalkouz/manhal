...
function showSetting() {
    ...
    str = '<div id="proprties"  class="proprties">' +
        ...
        '<div class="title-icon floating-left"></div>' +
        '<div class="title-container floating-left">' +
        '<span class="main-title">Set width 100%</span>' +
        '<span class="sub-title">Set width 100%</span>' +
        '</div>' +
        '<div class="check-container-onOf floating-right">' +
        ...
        '' +
        '' +
        '<section class="section settingSection help fillRandom" style="opacity: 0.5;pointer-events: none">' +
        '<div class="title-icon floating-left"></div>' +
        '<div class="title-container floating-left">' +
        '<span class="main-title">fill random</span>' +
        '<span class="sub-title">fill random</span>' +
        '</div>' +
        '<div class="check-container-onOf floating-right">' +
        ...
        '<div class="title-icon floating-left"></div>' +
        '<div class="title-container floating-left">' +
        '<span class="main-title">Set fill direction from right to left</span>' +
        '<span class="sub-title">Set fill direction from right to left</span>' +
        '</div>' +
        '<div class="check-container-onOf floating-right">' +
        ...
        '<div class="headProprties"><label>Style</label><a class="closePng" onclick="closeStyle()"><i></i></a></div>' +
    ...
    if(game.typeEdit == "fillBox"){
     $(".fillRandom").css({"opacity": "1","pointer-events": "auto"});
