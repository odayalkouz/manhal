...
function showFillBoxEditorAnswer() {
    ...
    str = '<div class="proprties">' +
        ...
        '<label>Add asnwers separate by space</label>' +
        '<a class="closePng" onclick="closeProprties()"><i></i></a>' +
        '</div>' +
        '<div class="bodyProprties">' +
        '<section class="section settingSection text">' +
        '<textarea class="titleText textAreaAnswer" placeholder="Enter answers text" type="text" value="' + textValue + '" id="">' + textValue + '</textarea>' +
        '</section>' +
        '' +
        ...
        '<a class="ok-btn floating-right" onclick="saveFillDataBox(' + index + ')" id="bgEditt"><i></i></a>' +
        '</div>' +
        '</div>' +
        '' +
...
function addTitleQustion() {
    ...
    string = '<div class="titleContainerHiehgtlight">' +
        ...
        '<label for="cir-option">Put circle</label>' +
        ...
        '<label for="cir-option-truefalse">True Or False</label>' +
        ...
        '<label for="cir-option-matching">matching</label>' +
        ...
        '<label for="cir-option-fillText">Fill box</label>' +
        ...
        '<a onclick=""  class="initGame saveTitle floating-right"><i></i></a>' +
        '</div>' +
        '</div>' +
