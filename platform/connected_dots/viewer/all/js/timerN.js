...
function buildTimer(){
    ...
    str='<div class="obj9 zoomInDown animated">'+
    '<div class="timer-clock flaticon-timer"></div>'+
    '<span id="timerCount" class="button-red button resizeText"></span>'+
    '<div id="timer" class="">'+
    ' <div class="bar">'+
    ' <div id="bar"></div>'+
    ' </div>'+
...
function TimeOut(){
    ...
    parent.soundEffect("sound/timeout.mp3")
    $(".body").msgBox({

        msgText1: "انتهى الوقت",
        msgText2: "حاول مره اخرى",
        imgSrc: "../../images/time-out.gif",
        ...
        cancelFn: function () {
            document.getElementById("messageContainer").style.display="none";
            //parent.createIframe("game-page.html");
        },

    });
    $('#messageContainer img').css({"top":"-39px","height":"121%"});
}
