...
<div class="main-container" id="main-container">
    <div class="inner-container" id="inner-container">
        ...
        <div class="game-container" style="opacity: 0">
            <div id="gameContainer" class="gameContainer gameContainer animated lightSpeedIn">
                <div class="headerGame">
                    <div class="inner-headerGame">
                        <label class="lbl-qustion">The rules and instructions to games can often be misplaced and?</label>
                    </div>
                </div>
                ...
                <div class="fotterGame">
                    ...
                    <div class="center-footer floating-left">
                        ...
                        <a id="helpIcon" class="hvr-bounce-in bounceInLeft animated floating-right" onclick="helpConnect(this)"><i></i></a>
                        <img id="hear" onclick="listen()" src="images/ear_button.png" style="display: none;">
                        <div id="Try" class="try floating-right">
                            <div class="try-icon floating-left"></div>
                            <div class="star-container floating-right">
                                <span class="floating-right"><img id="tryCounter0" class="hvr-rotate star slideInLeft animated" onclick="" src="../all/images/star.svg"></span>
                                <span class="floating-right"><img id="tryCounter1" class="hvr-rotate star slideInUp animated" onclick="" src="../all/images/star.svg"></span>
                                <span class="floating-right"><img id="tryCounter2" class=" hvr-rotate star slideInUp animated" onclick="" src="../all/images/star.svg"></span>
                                <span class="floating-right"><img id="tryCounter3" class="hvr-rotate star slideInRight animated" onclick="" src="../all/images/star.svg"></span>
                            </div>
                        </div>
...
<audio id="good">
    <source src="../all/sound/correct.mp3" type="audio/mpeg">
</audio>
<audio id="error1">
