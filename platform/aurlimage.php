...
<form id="aimage_form" method="POST" action="" enctype="multipart/form-data" target="upload_target">
    ...
    <div class="line-row-b">
        <input type="button" class="btn-default floating-right" id="update_aurlimage" value="<?=$Lang->Update;?>">
