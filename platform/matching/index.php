...
<header>
    ...
    <link href="css/cssMatching.css" rel="stylesheet" type="text/css">
    ...
    <script type="text/javascript" src="js/loadMatching.js"></script>
    <script type="text/javascript" src="js/UploadMatching.js"></script>
...
<!--            <a title="Add object from Almanhal library." class="btn library" onclick="createThumbs()"><i></i></a>-->
        ...
        <div id="gameContainer" class="gameContainer" >
            <div class="gameContent" >
                ...
                <section class="sectionMatching section1">
                    <div class="headMatching"></div>

                    <div class="addNewItem"><img src="images/idditem.png"></div>

                </section>
                <section class="section2">
                    <div class="headMatching"></div>
                    <div class="addNewItem2"><img src="images/idditem.png"></div>
                </section>
                </div>
            </div>
...
<div class="inputContainer">
    ...
    <input type="file" class="inputHide" id="soundEdittitle" UploadType="soundEdittitle" onchange="UploadType='soundEdittitle';getImageLocal(this)" name="upload" accept="audio/*">
