...
function TimeOut(){
    ...
    soundEffect("../en/sound/timeout.mp3")
    $(document.body).msgBox({

        msgText1: "images/timeout.svg",
        msgText2: "images/timeout.svg",
        imgSrc: "../all/images/falid.png",
    ...
    $('#lbl-data1').css({width:"60%",height:"25%",bottom:"19%"});
