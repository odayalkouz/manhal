...
(function ($) {
    ...
    var createContainer = function (tar) {
	    ...
	    if (game[0].option.typeViewr == "undefined" || typeof game[0].option.typeViewr == "undefined" || game[0].option.typeViewr != "Number") {
		    game[0].option.typeViewr = "letter"
		  
		    // $("#manhalpreOverlay").css({
			 //    background: "url(images/lodeer-bg.png)",
