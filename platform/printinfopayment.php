...
//
    ...
    $sql = "SELECT `payments_books`.*,`payments_books`.`type` as item_type,  `books`.`booktype` , `books`.`name`, `books`.`weight` as book_weight, `books`.`isbn` as book_isbn, `story`.`title` ,`story`.`isbn` as story_isbn,`story`.`weight` as story_weight, `products`.`name_ar`, `products`.`name_en` , `products`.`ISBN` as toy_isbn  ,`products`.`Weight` as toy_weight               
