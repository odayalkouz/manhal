<?php
$currentTab = "inprogressorders";
include_once '../includes/breadcrumb.php';
$bredcrumb="<li class='breadcrumb-item'><a href='../index.php'>".$Breadcrumbs->getlang('Dashboard')."</a></li><li class='breadcrumb-item active' aria-current='page'>".$Breadcrumbs->getlang('InProgressOrders')."</li>";
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-3 float-right">
                        <h5 class="card-title text-left"><?=$prosses->getlang('inprogressorders');?></h5>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="mb-0 table table-hover js-exportable">
                        ...
                        <tbody>
                        <?php echo $prosses->GetAllPendingOrder();?>
                        </tbody>
                    </table>
                </div>
            </div>
