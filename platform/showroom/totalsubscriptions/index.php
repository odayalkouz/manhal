<?php
$currentTab = "totalsubscriptions";
include_once '../includes/breadcrumb.php';
$bredcrumb="<li class='breadcrumb-item'><a href='../index.php'>".$Breadcrumbs->getlang('Dashboard')."</a></li><li class='breadcrumb-item active' aria-current='page'>".$Breadcrumbs->getlang('totalsubscriptions')."</li>";
            ...
            <div class="card-body">
                <div class="row">
                        <div class="col-lg-8 float-right">
                            <h5 class="card-title text-left"><?=$prosses->getlang('totalsubscriptions');?></h5>
                        </div>
                        <div class="col-lg-4 float-right margin-t-3">
                            <div class="col-lg-2 float-left">
                                <label class="label-withinput float-left"><?=$prosses->getlang('Date');?></label>
                            </div>
                ...
                <div class="table-responsive">
                    <table class="mb-0 table table-hover js-exportable">
                        ...
                        <tr>
                            ...
                            <th><?=$prosses->getlang('StartDate');?></th>
                            <th><?=$prosses->getlang('EndDate');?></th>
                            <th><?=$prosses->getlang('Number_of_purchases');?></th>
                        </tr>
                        </thead>
                        <tbody>
                            <?php
                            echo $prosses->GetDataSubscriptions();?>
                        </tbody>
                    </table>
                </div>
            </div>
