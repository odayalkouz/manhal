<?php
$currentTab = "CompletedOrders";
include_once '../includes/breadcrumb.php';
$bredcrumb="<li class='breadcrumb-item'><a href='../index.php'>".$Breadcrumbs->getlang('Dashboard')."</a></li><li class='breadcrumb-item active' aria-current='page'>".$Breadcrumbs->getlang('CompletedOrders')."</li>";
            ...
            <div class="card-body ">
                <div class="row">
                    <div class="col-lg-3 float-right">
                        <h5 class="card-title text-left"><?=$prosses->getlang('CompletedOrders');?></h5>
                    </div>
                    ...
                    <div class="col-lg-4 float-right margin-t-3">
                        <div class="col-lg-3 float-left">
                            <label class="label-withinput text-left floating-right"><?=$prosses->getlang('Date');?></label>
                        </div>
                        <div class="col-lg-9 float-left">
