...
function BookMessage() {
    window.parent.showBookMsg("Well Done","<span style='display: block;font-size: 2vmin;'>Your Score is</span ><span style='font-size: 2vmin;font-weight: bold;'>%"+per+"</span>",window.parent.$('iframe[src="'+window.location.href+'"]').closest(".element").attr("id"));
