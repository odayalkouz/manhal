...
<form id="aurl_form" method="POST" action="" enctype="multipart/form-data" target="upload_target">
    ...
    <div class="line-row-b">
        <input class="btn-default floating-right" type="button" id="update_aurl" value="<?=$Lang->Update;?>">
