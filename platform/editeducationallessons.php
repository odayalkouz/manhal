...
$bredcrumb = '<li class="floating-left"><a href="educationallessons.php" class="floating-left">'.$Lang->EducationalLessons.'</a></li><span class="floating-left">/</span><li class="floating-left"><a href="editeducationallessons.php" class="floating-left active">'.$Lang->EditEducationalLesson.'</a></li>';
        ...
        <form id="editbook">
            ...
            <div class="display-inline-block floating-left">
                <div class="line-row">
                    ...
                    <input type="text" class="txt-a floating-left effect-8" id="title_ar" name="title_ar" placeholder="<?= $Lang->arabicname ?>" value="احمد">
