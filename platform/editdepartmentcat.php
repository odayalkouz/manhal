...
$sql ="SELECT * FROM departments WHERE catid=".$_GET['id'];
...
<script type="text/javascript" >
    ...
    function savecategory(){
        ...
        var data={
            ...
            TypeProcesses:'updatedepartments'
        };

        setdatafunction('updatedepartments',data);
    }
...
$bredcrumb = '<li class="floating-left"><a href="store_dep.php" class="floating-left">'.$Lang->Category.'</a></li><span class="floating-left">/</span><li class="floating-left"><a class="floating-left active">'.$Lang->EditCategory.'</a></li>';
