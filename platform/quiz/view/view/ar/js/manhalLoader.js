...
(function ($) {
    ...
    var loadComplete = function () {
        ...
        $(jBar).stop().animate({
            ...
            $(".viewer-container .first-section-viewer .title h1").fadeIn();
            setTimeout(function () {
                // $(".silver-container .content-container .top-content article .shine").animate({left: '150%'},200);
                $(".silver-container .content-container .square-quiz-container .boxes").animate({opacity: '1'},200);
                setTimeout(function () {
                    $(".silver-container .content-container .square-quiz-container .box-e").animate({opacity: '1'},200);
                    setTimeout(function () {
                        $(".silver-container .content-container .square-quiz-container .box-a").animate({opacity: '1'},200);
                        setTimeout(function () {
                            $(".silver-container .content-container .square-quiz-container .box-d").animate({opacity: '1'},200);
                            setTimeout(function () {
                                $(".silver-container .content-container .square-quiz-container .box-c").animate({opacity: '1'},200);
                                setTimeout(function () {
                                    $(".silver-container .content-container .square-quiz-container .box-b").animate({opacity: '1'},200);
                                    setTimeout(function () {
                                        $(".silver-container .content-container .btn-start-container").addClass("animated zoomIn").fadeIn();
                                    }, 200);
                                }, 200);
                            }, 200);
                        }, 200);
