...
function printDiv()
{
   ...
   var b91= $(window).height();
    ...
    newWin.document.write('<html><head><link href="../all/thems/en/css/swiper.min.css" rel="Stylesheet" type="text/css"/><link rel="Stylesheet" type="text/css" href="../all/thems/en/css/print.css" /></head><body onload="window.print()"><section class="quiz-container"><div class="result-page-container">'+divToPrint1.innerHTML+ "</div>" + divToPrint.innerHTML+'</section></body></html>');
