...
function printDiv()
{
   ...
   var b91= $(window).height();
    ...
    newWin.document.write('<html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><link href="../all/thems/en/css/swiper.min.css" rel="Stylesheet" type="text/css"/><link rel="Stylesheet" type="text/css" href="../all/thems/en/css/print.css" /><link rel="Stylesheet" type="text/css" href="../all/thems/en/css/size1.css" /></head><body onload="window.print()"><section class="quiz-container"><div class="result-page-container">'+divToPrint1.innerHTML+ "</div>" + divToPrint.innerHTML+'</section></body></html>');
