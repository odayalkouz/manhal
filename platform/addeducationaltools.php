...
$cuerrentpage = "educationaltools.php";
...
$bredcrumb = '<li class="floating-left"><a href="educationaltools.php" class="floating-left">'.$Lang->EducationalTools.'</a></li><span class="floating-left">/</span><li class="floating-left"><a href="addeducationaltools.php" class="floating-left active">'.$Lang->AddEducationalTools.'</a></li>';
