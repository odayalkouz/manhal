...
$sql ="SELECT * FROM brand WHERE catid=".$_GET['id'];
...
<script type="text/javascript" >
    ...
    function savecategory(){
        ...
        var data={
            ...
            TypeProcesses:'updatebrand'
        };

        setdatafunction('updatebrand',data);
    }
...
$bredcrumb = '<li class="floating-left"><a href="store_brands.php" class="floating-left">'.$Lang->Category.'</a></li><span class="floating-left">/</span><li class="floating-left"><a class="floating-left active">'.$Lang->EditCategory.'</a></li>';
