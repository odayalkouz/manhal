    ...
    <div class="form-container">
        <form id="editbook">
            ...
            <div class="display-inline-block floating-left">
                ...
                <div class="line-row">
                    ...
                    <input type="text" class="txt-a floating-left" id="story_author" name="story_author" placeholder="<?= $Lang->Author;?>" value="<?=$row["author"]; ?>">
                </div>
                <div class="line-row">
                    ...
                    <select class="txt-a floating-left" id="category" name="Category">
                        ...
                        if (mysqli_num_rows($cat_result) > 0) {
                            while ($cat_row = mysqli_fetch_assoc($cat_result)) {
                                ...
                                echo "<option ".$selected." value='".$cat_row['catid']."'>".$cat_row['name_'.strtolower($_SESSION['lang'])]."</option>";
                            }
                        }
                        ?>
                    </select>
        ...
        <form id="screenshots_form" action="ajax/editor.php?process=screenshotsstory&storyid=<?=$row['storyid'];?>&seriesid=<?=$row['seriesid'];?>" method="post" target="hidden_iframe" enctype="multipart/form-data">
            ...
            <div class="line-row">
                ...
                <div class="fu-container-a floating-left">
                    <label class="floating-left flaticon-cloud148 label-a"></label>
                    <label class="label-b floating-left" id="lblbgsound"></label>
                    <input class="txt-a floating-left" id="bgsound" type="file" name="bgsound" placeholder="<?= $Lang->BackgroundSound;?>" value="">
                </div>
                <audio controls>
                    <source src="stories/<?=$row["seriesid"];?>/story/<?=$_GET["id"];?>/sound/bgsound.mp3" type="audio/mpeg">
                    Your browser does not support the audio element.
                </audio>
            </div>
            <div class="line-row">
                <label class="lbl-data-a floating-left"><?= $Lang->ChildSound;?></label>
                <div class="fu-container-a floating-left">
                    <label class="floating-left flaticon-cloud148 label-a"></label>
                    <label class="label-b floating-left" id="lblchildsound"></label>
                    <input class="txt-a floating-left" id="childsound" type="file" name="childsound" placeholder="<?= $Lang->ChildSound;?>" value="">
                </div>
                <audio controls>
                    <source src="stories/<?=$row["seriesid"];?>/story/<?=$_GET["id"];?>/sound/childsound.mp3" >
                    Your browser does not support the audio element.
                </audio>
            </div>
