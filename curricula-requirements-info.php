            ...
            <div class="display-row">
                <div class="display-cell">
                    <div class="image-header-container">
                        <h1><?= $Lang->CurriculaRequirements;?></h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="center-piece" style="overflow: visible">
            <div class="inner-container">
                <div class="items-main-container">
                    <div class="display-block-a-info" id="curricula-requirements">
                        <div class="item-container">
                            <div class="inner-item-container">
                                <p class="inner-paragraph"><?=$Lang->curricularequirementsinfoDesc?></p>
                            </div>
                            <div class="note rounded" >
                                <label class="image floating-left"></label>
                                <h2 class="floating-left title"><?=$Lang->daralmanhcurricularequirementsinfoinformations?></h2>
                            </div>
                        </div>
                    </div>
                </div>
