...
var RulersGuides = function (evt, dragdrop) {
    ...
    var doc         = document.documentElement,
        ...
        resizeTimer = null,
        snapDom     = 0,
        cssText     = 'html,body{margin:0;padding:0}.rg-overlay{position:absolute;top:0px;left:0;overflow:hidden}.guide{position:absolute;top:0;left:0;z-index:9991;font-size:0}.guide.v{width:1px;height:7000px;border-right:solid 1px #74ba3e;cursor:col-resize}.guide.h{width:3000px;height:1px;border-bottom:solid 1px #74ba3e;cursor:row-resize}.info{width:50px;height:25px;line-height:25px;text-align:center;position:relative;font-size:13px;background-color:#eee;border:solid 1px #ccc;color:#00AB67}.guide.v .info{left:2px}.guide.h .info{top:2px}.unselectable{-moz-user-select:-moz-none;-khtml-user-select:none;-webkit-user-select:none;-ms-user-select:none;user-select:none}.ruler{background-color:#e8e8e8;position:absolute;top:40px;left:0;z-index:9999}.ruler .label{font:12px Arial;color:#00AB67}.ruler,.ruler span{font-size:0}.ruler.h{width:100%;left:-1px;padding-top:20px;border-bottom:solid 1px #00AB67}.ruler.v{height:100%;top:40px;padding-left:16px;width:25px;border-right:solid 1px #00AB67}.ruler.h span{border-left:solid 1px #00AB67;height:0px;width:1px;vertical-align:bottom;display:inline-block;*display:inline;zoom:1}.ruler.v span{display:block;margin-left:auto;margin-right:0;border-top:solid 1px #00AB67;width:0px;height:1px}.ruler.v span.major{border-top:solid 1px #00AB67;width:13px}.ruler.v span.milestone{position:relative;border-top:solid 1px #00AB67;width:17px}.ruler.v span.label{border:0;font-size:9px;position:absolute;text-align:center;width:9px}.ruler.h span.major{border-left:solid 1px #00AB67;height:13px}.ruler.h span.milestone{position:relative;border-left:solid 1px #00AB67;height:17px}.ruler.h span.label{border:0;font-size:9px;position:absolute;text-align:center;top:-14px;width:9px}.ruler.h .l10{left:-5px}.ruler.h .l100{left:-7px}.ruler.h .l1000{left:-10px}.ruler.v .l10,.ruler.v .l100,.ruler.v .l1000{top:-7px}.ruler.v .l10{left:-12px}.ruler.v .l100{left:-17px}.ruler.v .l1000{left:-23px}.menu-btn{position: fixed; right: 119px ; top: 7px ; line-height: 9px; z-index: 999999 ; width: 23px ; height: 22px ; background-color: #84c250; font-size: 26px; text-align: left; color: #fff; font-weight: 700; cursor: pointer; border-radius: 2px;}.rg-menu{position:fixed;top:40px;right:116px;padding:0;margin:0;list-style:none;display:none;font:13px Arial;z-index:9999;box-shadow:2px 2px 10px #ccc}.rg-menu li{text-align:left;border-bottom:solid 1px #00AB67;padding:0}.rg-menu a{background-color:#063d43;display:block;padding:5px;text-decoration:none;color:#fff;line-height:18px}.rg-menu a:hover,.rg-menu a.selected{color:#fff;background-color:#84c250}.rg-menu a.disabled{color:#ccc}.rg-menu .desc{display:inline-block;width:170px}.dialog{position:fixed;background-color:#063d43;z-index:9999;color:#fff;font-size:13px;display:none;box-shadow:2px 2px 10px #ccc}.dialog button{border:0;color:#333;cursor:pointer;background-color:#eaeaea;background-image:linear-gradient(#fafafa,#eaeaea);background-repeat:repeat-x;border-radius:3px;text-shadow:0 1px 0 rgba(255,255,255,.9)}.dialog input,.dialog select,.dialog button{font-size:13px;margin:3px;padding:3px}.dialog .title-bar{padding:5px;background-color:#aaa;font-weight:700}.dialog .wrapper{padding:10px}.open-dialog select,.open-dialog button{float:left;display:block}.open-dialog .ok-btn,.open-dialog .cancel-btn{margin:10px 3px}.open-dialog .ok-btn{clear:both}.snap-dialog label{font-weight:700;padding:3px}.snap-dialog .ok-btn{margin-left:18px}.snap-dialog .ok-btn,.snap-dialog .cancel-btn{margin-top:10px}.snap-dialog .rg-y-label{margin-left:10px}#rg-x-snap,#rg-y-snap{width:50px}.info-block-wrapper{position:absolute;z-index:9989}.info-block{position:absolute;text-align:left}.info-block.even{background:0 0;background-color:rgba(0,0,255,.2);-ms-filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=#330000FF, endColorstr=#330000FF);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=#330000FF, endColorstr=#330000FF);zoom:1}.info-block.odd{background:0 0;background-color:rgba(255,0,0,.2);-ms-filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=#33FF0000, endColorstr=#33FF0000);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=#33FF0000, endColorstr=#33FF0000);zoom:1}.info-block-txt{padding:5px;display:inline-block;vertical-align:top;background-color:#063d43;color:#fff;font-size:13px;*display:inline;zoom:1}',
        ...
        prepare     = function () {
            ...
            setTimeout(function () {
                hRuler = new Ruler('h', $(window).width());
                vRuler = new Ruler('v', $(window).height()+600);
