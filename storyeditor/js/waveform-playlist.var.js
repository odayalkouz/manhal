	...
	function init() {
	  ...
	  var defaults = {
	    ...
	    zoomLevels: [64, 128, 256, 512, 1024, 2048, 4096],
		  // zoomLevels: [512, 1024, 2048, 4096, 5120, 6144, 7168, 8192, 9216, 16384],
	    annotationList: {
	      annotations: [],
	      controls: [],
	      editable: true,
	    ...
	    */
	    ...
	    value: function render(data) {
	      ...
	      return (0, _h2.default)('div.channel-wrapper' + audibleClass + customClass, {
	        attributes: {
	          style: 'margin-left: ' + channelMargin + 'px; height: ' + data.height * numChan + 'px;width:10000px;'
	        }
	      }, channelChildren);
	    }
	  }, {
	  ...
	  _createClass(AnnotationList, [{
	    ...
	    value: function render() {
	      ...
	      var boxes = (0, _h2.default)('div.annotations-boxes', {
	        ...
	        }, [note.lines]), _this4.renderResizeRight(i)]);
	      }));
