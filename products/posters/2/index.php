        ...
        <div class="center-piece-series custom">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6">
                    <button class="btn btn-long cart1 floating-left" data-type="book" data-id="1547"><?=$Lang->AddCart;?></button>
                </div>
            </div>
        </div>
    </div>
    <div class="container-fluid mt-2 mb-3 text-left">
        <div class="row">
            <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12 ">
                <div class="card">
                    <div class="demo zoom-box">
                        <ul id="lightSlider">
                            <li data-thumb="<?=SITE_URL;?>products/posters/2/slider/0.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/posters/2/slider/0.jpg" xoriginal="<?=SITE_URL;?>products/posters/2/slider/0.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/posters/2/slider/1.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/posters/2/slider/1.jpg" xoriginal="<?=SITE_URL;?>products/posters/2/slider/1.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/posters/2/slider/2.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/posters/2/slider/2.jpg" xoriginal="<?=SITE_URL;?>products/posters/2/slider/2.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/posters/2/slider/3.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/posters/2/slider/3.jpg" xoriginal="<?=SITE_URL;?>products/posters/2/slider/3.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/posters/2/slider/4.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/posters/2/slider/4.jpg" xoriginal="<?=SITE_URL;?>products/posters/2/slider/4.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/posters/2/slider/5.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/posters/2/slider/5.jpg" xoriginal="<?=SITE_URL;?>products/posters/2/slider/5.jpg"/></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-lg-7 col-md-12 col-sm-12 col-xs-12 order-2">
                <div class="card">
                    <div class="about">
                        <h4 class="" style="font-family:'Droid Arabic Kufi';text-align: right">براعم العربية - بوسترات</h4>
                        <span class="font-weight-bold current-price" style="float: right"><label>$</label><label><?=$campainPrice['1547']['new'];?></label></span>
                        <span class="old-price " style="float: right"><label>$</label><label><?=$campainPrice['1547']['old'];?></label></span>
                        <label class="font-weight-bold sale1" style="float: right"><?=$Lang->sale;?></label>
                    </div>
                    <div class="Type-content">
                        <label><?=$Lang->Type;?></label>
                        <a class="item-varient active" Oprice="<?=$campainPrice['1547']['old'];?>" Bprice="<?=$campainPrice['1547']['new'];?>" productid="1547"><?=$Lang->levelOne;?></a>
                        <a class="item-varient" Oprice="<?=$campainPrice['1548']['old'];?>" Bprice="<?=$campainPrice['1548']['new'];?>" productid="1548"><?=$Lang->levelTow;?></a>
                    </div>
                    <div class="row">
                            ...
                            <div class="quantity-content">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 quatitly11">
                                        ...
                                        <button class="btn btn-long cart1 floating-left hide-modal" id="add_to_cart" data-type="book" data-id="1547"><?=$Lang->AddCart;?></button>
                                    </div>
                            ...
                            <div class="br-dashed">
                                <div class="row">
                                    <div class="col-md-12 col-xs-10">
                                        <div class="bullets">
                                            <div class="d-flex align-items-center"> <span class="dot"></span> <span class="bullet-text"><?=$Lang->addspostersB1;?></span></div>
                                            <div class="d-flex align-items-center"> <span class="dot"></span> <span class="bullet-text"><?=$Lang->addspostersB2;?></span></div>
                                            <div class="d-flex align-items-center"> <span class="dot"></span> <span class="bullet-text"><?=$Lang->addspostersB3;?></span></div>
                                            <div class="d-flex align-items-center"> <span class="dot"></span> <span class="bullet-text"><?=$Lang->addspostersB4;?></span></div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="product-description">
                                            <div class="mt-2"> <span class="title"><?=$Lang->AboutEducationalCards;?></span>
                                                <p><?=$Lang->posterTowEnParagraph;?></p>
                                                <p><?=$Lang->posterTowArParagraph;?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="bbb_viewed_slider_container">
                                    <div class="owl-carousel owl-theme bbb_viewed_slider">
                                        ...
                                        <div class="owl-item">
                                            <div class="bbb_viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                                <a href="<?=SITE_URL;?><?=$_SESSION['lang'];?>/product/books/b2/براعم-العربية-2" class="bbb_viewed_image">
                                                    <img src="<?=SITE_URL;?>products/books/b2/slider/0.jpg" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="owl-item">
                                            <div class="bbb_viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                                <a href="<?=SITE_URL;?><?=$_SESSION['lang'];?>/product/cards/1أصدقاء-العربية-بطاقات-تعليمية" class="bbb_viewed_image">
                                                    <img src="<?=SITE_URL;?>products/cards/1/slider/0.jpg" alt="">
                                                </a>
                                            </div>
                                        </div>
