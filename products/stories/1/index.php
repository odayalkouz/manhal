    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="first"><span class="sell-arb floating-left">يباع</span><span class="up-sell-book-title floating-left">أشبال الأقصى</span><span class="floating-left"><?=$Lang->upsalemessage1;?></span></p>
        ...
        <div class="center-piece-series custom">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6">
                    <button class="btn btn-long cart1 floating-left" data-type="story" data-id="3455"><?=$Lang->AddCart;?></button>
                </div>
            </div>
        </div>
    </div>
    <div class="container-fluid mt-2 mb-3 text-left">
        <div class="row">
            <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12 ">
                <div class="card">
                    <div class="demo zoom-box">
                        <ul id="lightSlider">
                            <li data-thumb="<?=SITE_URL;?>products/stories/1/slider/0.jpg" class=""><img class="image-slider1 xzoom" src="<?=SITE_URL;?>products/stories/1/slider/0.jpg" xoriginal="<?=SITE_URL;?>products/stories/1/slider/0.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/stories/1/slider/1.jpg" class=""><img class="image-slider1 xzoom" src="<?=SITE_URL;?>products/stories/1/slider/1.jpg" xoriginal="<?=SITE_URL;?>products/stories/1/slider/1.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/stories/1/slider/2.jpg" class=""><img class="image-slider1 xzoom" src="<?=SITE_URL;?>products/stories/1/slider/2.jpg" xoriginal="<?=SITE_URL;?>products/stories/1/slider/2.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/stories/1/slider/3.jpg" class=""><img class="image-slider1 xzoom" src="<?=SITE_URL;?>products/stories/1/slider/3.jpg" xoriginal="<?=SITE_URL;?>products/stories/1/slider/3.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/stories/1/slider/4.jpg" class=""><img class="image-slider1 xzoom" src="<?=SITE_URL;?>products/stories/1/slider/4.jpg" xoriginal="<?=SITE_URL;?>products/stories/1/slider/4.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/stories/1/slider/5.jpg" class=""><img class="image-slider1 xzoom" src="<?=SITE_URL;?>products/stories/1/slider/5.jpg" xoriginal="<?=SITE_URL;?>products/stories/1/slider/5.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/stories/1/slider/6.jpg" class=""><img class="image-slider1 xzoom" src="<?=SITE_URL;?>products/stories/1/slider/6.jpg" xoriginal="<?=SITE_URL;?>products/stories/1/slider/6.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/stories/1/slider/7.jpg" class=""><img class="image-slider1 xzoom" src="<?=SITE_URL;?>products/stories/1/slider/7.jpg" xoriginal="<?=SITE_URL;?>products/stories/1/slider/7.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/stories/1/slider/8.jpg" class=""><img class="image-slider1 xzoom" src="<?=SITE_URL;?>products/stories/1/slider/8.jpg" xoriginal="<?=SITE_URL;?>products/stories/1/slider/8.jpg"/></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-lg-7 col-md-12 col-sm-12 col-xs-12 order-2">
                <div class="card">
                    <div class="about">
                        <h4 class="" style="font-family:'Droid Arabic Kufi';text-align: right">أشبال الأقصى</h4>
                        <span class="font-weight-bold current-price" style="float: right"><label>$</label><label ><?=$campainPrice['3455']['new'];?></label></span>
                        <span class="old-price " style="float: right"><label>$</label><label><?=$campainPrice['3455']['old'];?></label></span>
                        <label class="font-weight-bold sale1 " style="float: right"><?=$Lang->sale1;?></label>
                    </div>
                    <div class="Type-content" style="display: none">
                        <label><?=$Lang->Type;?></label>
                        <a class="item-varient active" Oprice="<?=$campainPrice['3455']['old'];?>" Bprice="<?=$campainPrice['3455']['new'];?>" ><?=$Lang->stories6;?></a>
                    </div>
                    <div class="row">
                            ...
                            <div class="quantity-content">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 quatitly11">
                                        ...
                                        <button class="btn btn-long cart1 floating-left" id="add_to_cart" data-type="story" data-id="3455"><?=$Lang->AddCart;?></button>
                                    </div>
                            ...
                            <div class="br-dashed">
                                <div class="row">
                                    <div class="col-md-12 col-xs-10">
                                        <div class="bullets">
                                            <div class="d-flex align-items-center"> <span class="dot"></span> <span class="bullet-text"><?=$Lang->Itcontains6stories;?></span> </div>
                                            <div class="d-flex align-items-center"> <span class="dot"></span> <span class="bullet-text"><?=$Lang->addsstoriesOne1;?></span> </div>
                                            <div class="d-flex align-items-center"> <span class="dot"></span> <span class="bullet-text"><?=$Lang->addsstoriesOne2;?></span> </div>
                                            <div class="d-flex align-items-center"> <span class="dot"></span> <span class="bullet-text"><?=$Lang->addsstoriesOne3;?></span> </div>
                                            <div class="d-flex align-items-center"> <span class="dot"></span> <span class="bullet-text"><?=$Lang->addsstoriesOne5;?></span> </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="product-description">
                                            <div class="mt-2"> <span class="title"><?=$Lang->AboutSeries;?></span>
                                                <p><?=$Lang->AboutSeriesparagraphS1English;?></p>
                                                <p><?=$Lang->AboutSeriesparagraphS1Arabic;?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="product-description">
                    <div class="mt-2">
                        <div class="row mt-lg-0 mt-sm-0 mt-md-0">
                            <div class="col-lg-7 col-md-12 col-sm-12 mt-lg-5 mt-md-0 mt-sm-0">
                                <div class="row" >
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                        <div class="bullets" style="float: right">
                                            <div class="d-flex align-items-center"> <span class="dot"></span> <span class="bullet-text" style="font-family:'Droid Arabic Kufi'">التحدي الكبير</span> </div>
                                            <div class="d-flex align-items-center"> <span class="dot"></span> <span class="bullet-text" style="font-family:'Droid Arabic Kufi'">مرحبًا بكم في القدس</span> </div>
                                            <div class="d-flex align-items-center"> <span class="dot"></span> <span class="bullet-text" style="font-family:'Droid Arabic Kufi'">زيتونة الأقصى</span> </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12 ">
                                        <div class="bullets" style="float: right">
                                            <div class="bullets" style="float: right">
                                                <div class="d-flex align-items-center"> <span class="dot"></span> <span class="bullet-text" style="font-family:'Droid Arabic Kufi'">شقيق الحرمين</span> </div>
                                                <div class="d-flex align-items-center"> <span class="dot"></span> <span class="bullet-text" style="font-family:'Droid Arabic Kufi'">ذوات الضفائر</span> </div>
                                                <div class="d-flex align-items-center"> <span class="dot"></span> <span class="bullet-text" style="font-family:'Droid Arabic Kufi'">فارس الأقصى</span> </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-5 col-md-12 col-sm-12 text-center text-center">
                                <img class="thumb-item" src="<?=SITE_URL;?>products/stories/1/content/1.jpg">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <style> #feedback_form{display: none;}</style>
        <?php
