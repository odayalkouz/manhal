    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="first"><span class="sell-arb floating-left">يباع</span><span class="up-sell-book-title floating-left">براعم العربية 2</span><span class="floating-left"><?=$Lang->upsalemessage1;?></span></p>
                                ...
                                <div class="owl-item" title="براعم العريبة - بوسترات">
                                    <div class="bbb_viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                        <a href="<?=SITE_URL;?>en/product/posters/2/براعم-العربية">
                                            <img src="<?=SITE_URL;?>products/posters/2/slider/1.jpg" alt="">
                                            <div class="about1">
                                                <span class="font-weight-bold current-price " style="float: right">$<?=$campainPrice['1548']['new'];?></span>
                                                <span class="old-price" style="float: right">$<?=$campainPrice['1548']['old'];?></span>
                                            </div>
                                            <div class="owl-item-title"><h5>براعم العربية - بوسترات</h5></div>
                                        </a>
                                        <button class="btn btn-long cart1 floating-left jq_addcart_upsell" data-type="book" data-id="1548"><?=$Lang->Add;?></button>
                                    </div>
                                </div>
                                ...
                                <div class="owl-item" title="حكايات الزرافة">
                                    <div class="bbb_viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                        <a href="<?=SITE_URL;?>en/product/stories/3/حكايات-الزرافة">
                                            ...
                                            <div class="about1">
                                                <span class="font-weight-bold current-price " style="float: right">$<?=$campainPrice['3452']['new'];?></span>
                                                <span class="old-price" style="float: right">$<?=$campainPrice['3452']['old'];?></span>
                                            </div>
                                            <div class="owl-item-title"><h5>حكايات الزرافة</h5></div>
                                        </a>
                                        <button class="btn btn-long cart1 floating-left jq_addcart_upsell" data-type="story" data-id="3452"><?=$Lang->Add;?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="center-piece-series custom">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6">
                    <button class="btn btn-long cart1 floating-left" data-type="book" data-id="1511"><?=$Lang->AddCart;?></button>
                </div>
            </div>
        </div>
    </div>
    <div class="container-fluid mt-2 mb-3 text-left">
        <div class="row">
            <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12 ">
                <div class="card">
                    <div class="demo zoom-box">
                        <ul id="lightSlider">
                            <li data-thumb="<?=SITE_URL;?>products/books/b2/slider/0.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/books/b2/slider/0.jpg" xoriginal="<?=SITE_URL;?>products/books/b2/slider/0.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/books/b2/slider/1.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/books/b2/slider/1.jpg" xoriginal="<?=SITE_URL;?>products/books/b2/slider/1.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/books/b2/slider/2.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/books/b2/slider/2.jpg" xoriginal="<?=SITE_URL;?>products/books/b2/slider/2.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/books/b2/slider/3.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/books/b2/slider/3.jpg" xoriginal="<?=SITE_URL;?>products/books/b2/slider/3.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/books/b2/slider/4.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/books/b2/slider/4.jpg" xoriginal="<?=SITE_URL;?>products/books/b2/slider/4.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/books/b2/slider/5.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/books/b2/slider/5.jpg" xoriginal="<?=SITE_URL;?>products/books/b2/slider/5.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/books/b2/slider/6.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/books/b2/slider/6.jpg" xoriginal="<?=SITE_URL;?>products/books/b2/slider/6.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/books/b2/slider/7.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/books/b2/slider/7.jpg" xoriginal="<?=SITE_URL;?>products/books/b2/slider/7.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/books/b2/slider/8.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/books/b2/slider/8.jpg" xoriginal="<?=SITE_URL;?>products/books/b2/slider/8.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/books/b2/slider/9.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/books/b2/slider/9.jpg" xoriginal="<?=SITE_URL;?>products/books/b2/slider/9.jpg"/></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-lg-7 col-md-12 col-sm-12 col-xs-12 order-2">
                <div class="card">
                    <div class="about">
                        <h4 class="" style="font-family:'Droid Arabic Kufi';text-align: right">براعم العربية 2</h4>
                        <span class="font-weight-bold current-price" style="float: right"><label>$</label><label><?=$campainPrice['1511']['new'];?></label></span>
                        <span class="old-price " style="float: right"><label>$</label><label><?=$campainPrice['1511']['old'];?></label></span>
                        <label class="font-weight-bold sale1" style="float: right"><?=$Lang->sale;?></label>
                    </div>
                    <div class="Type-content">
                        <label><?=$Lang->Type;?></label>
                        <a class="item-varient active" Oprice="<?=$campainPrice['1511']['old'];?>" Bprice="<?=$campainPrice['1511']['new'];?>" productid="1511"><?=$Lang->StudentBook_EBook;?></a>
                        <a class="item-varient" Oprice="<?=$campainPrice['1512']['old'];?>" Bprice="<?=$campainPrice['1512']['new'];?>" productid="1512"><?=$Lang->ActivityBook_EBook;?></a>
                        <a class="item-varient" Oprice="<?=$campainPrice['1513']['old'];?>" Bprice="<?=$campainPrice['1513']['new'];?>" productid="1513"><?=$Lang->TeacherBook;?></a>
                        <a class="item-varient" Oprice="<?=$campainPrice['1514']['old'];?>" Bprice="<?=$campainPrice['1514']['new'];?>" productid="1514"><?=$Lang->StudentBook_ActivityBook_EBook;?></a>
                    </div>
                    <div class="row">
                            ...
                            <div class="quantity-content">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 quatitly11">
                                        ...
                                        <button class="btn btn-long cart1 floating-left" id="add_to_cart" data-type="book" data-id="1511"><?=$Lang->AddCart;?></button>
                                    </div>
                ...
                <div class="product-description">
                    <div class="mt-2">
                                ...
                                <div class="row" style="direction: rtl;">
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                        <div class="bullets" style="float: right">
                                            <a href="<?=SITE_URL;?><?=$_SESSION['lang'];?>/product/books/b1" class="d-flex align-items-center"><span class="dot"></span><span style="font-family: 'Droid Arabic Kufi'" class="bullet-text">براعم العربية 1</span></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                        <div class="bullets" style="float: right">
                                            <a  href="<?=SITE_URL;?><?=$_SESSION['lang'];?>/product/books/b2" class="d-flex align-items-center"><span class="dot"></span><span style="font-family: 'Droid Arabic Kufi'" class="bullet-text">براعم العربية 2</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mt-lg-5 mt-sm-0 mt-md-0">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 text-center order-1">
                                <img style="width: 88%" class="thumb-item" src="<?=SITE_URL;?>products/books/b2/content/4.jpg">
                            </div>
                            <div class="col-lg-6 col-md-12 col-sm-12 order-2">
                                <span class="title"><?=$Lang->TeacherBook;?></span>
                                <p><?=$Lang->braemTowTeacher;?></p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="bbb_viewed_slider_container">
                                    <div class="owl-carousel owl-theme bbb_viewed_slider">
                                        ...
                                        <div class="owl-item" >
                                            <div class="bbb_viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                                <a href="<?=SITE_URL;?><?=$_SESSION['lang'];?>/product/books/a4/أصدقاء-العربية-2" class="bbb_viewed_image">
                                                    <img src="<?=SITE_URL;?>products/books/a4/slider/0.jpg" alt="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="owl-item" >
                                        ...
                                        <div class="owl-item">
                                            <div class="bbb_viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                                <a href="<?=SITE_URL;?><?=$_SESSION['lang'];?>/product/books/d3/هيا إلى الإيمان 2" class="bbb_viewed_image">
                                        ...
                                        <div class="owl-item">
                                            <div class="bbb_viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                                <a href="<?=SITE_URL;?><?=$_SESSION['lang'];?>/product/books/f2/Call to Faith 2" class="bbb_viewed_image">
                                                    <img src="<?=SITE_URL;?>products/books/f2/slider/0.jpg" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
