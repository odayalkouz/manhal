                                ...
                                <div class="owl-item" title="أصدقاء العريبة - بوسترات">
                                    <div class="bbb_viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                        <a href="<?=SITE_URL;?>en/product/posters/1/أصدقاء-العربية">
                                            ...
                                            <div class="about1">
                                                <span class="font-weight-bold current-price " style="float: right">$<?=$campainPrice['1542']['new'];?></span>
                                                <span class="old-price" style="float: right">$<?=$campainPrice['1542']['old'];?></span>
                                            </div>
                                ...
                                <div class="owl-item" title="أصدقاء العريبة - بطاقات تعليمية">
                                    <div class="bbb_viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                        <a href="<?=SITE_URL;?>en/product/cards/1/أصدقاء-العربية-بطاقات-تعليمية">
                                            ...
                                            <div class="about1">
                                                <span class="font-weight-bold current-price " style="float: right">$<?=$campainPrice['1539']['new'];?></span>
                                                <span class="old-price" style="float: right">$<?=$campainPrice['1539']['old'];?></span>
                                            </div>
        ...
        <div class="center-piece-series custom">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6">
                    <button class="btn btn-long cart1 floating-left" data-type="book" data-id="1485"><?=$Lang->AddCart;?></button>
                </div>
            </div>
        </div>
    </div>
    <div class="container-fluid mt-2 mb-3 text-left">
        <div class="row">
            <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12 ">
                <div class="card">
                    <div class="demo zoom-box">
                        <ul id="lightSlider">
                            <li data-thumb="<?=SITE_URL;?>products/books/a1/slider/0.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/books/a1/slider/0.jpg" xoriginal="<?=SITE_URL;?>products/books/a1/slider/0.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/books/a1/slider/4.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/books/a1/slider/4.jpg" xoriginal="<?=SITE_URL;?>products/books/a1/slider/4.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/books/a1/slider/5.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/books/a1/slider/5.jpg" xoriginal="<?=SITE_URL;?>products/books/a1/slider/5.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/books/a1/slider/6.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/books/a1/slider/6.jpg" xoriginal="<?=SITE_URL;?>products/books/a1/slider/6.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/books/a1/slider/7.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/books/a1/slider/7.jpg" xoriginal="<?=SITE_URL;?>products/books/a1/slider/7.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/books/a1/slider/1.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/books/a1/slider/1.jpg" xoriginal="<?=SITE_URL;?>products/books/a1/slider/1.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/books/a1/slider/2.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/books/a1/slider/2.jpg" xoriginal="<?=SITE_URL;?>products/books/a1/slider/2.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/books/a1/slider/3.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/books/a1/slider/3.jpg" xoriginal="<?=SITE_URL;?>products/books/a1/slider/3.jpg"/></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-lg-7 col-md-12 col-sm-12 col-xs-12 order-2">
                <div class="card">
                    <div class="about">
                        <h4 class="" style="font-family:'Droid Arabic Kufi';text-align: right">أصدقاء العربية - البستان</h4>
                        <span class="font-weight-bold current-price" style="float: right"><label>$</label><label><?=$campainPrice['1485']['new'];?></label></span>
                        <span class="old-price " style="float: right"><label>$</label><label><?=$campainPrice['1485']['old'];?></label></span>
                        <label class="font-weight-bold sale1" style="float: right"><?=$Lang->sale;?></label>
                    </div>
                    <div class="Type-content">
                        <label><?=$Lang->Type;?></label>
                        <a class="item-varient active" Oprice="<?=$campainPrice['1485']['old'];?>" productid="1485" Bprice="<?=$campainPrice['1485']['new'];?>" onclick="slider.goToSlide(0);"><?=$Lang->StudentBook_EBook;?></a>
                        <a class="item-varient" Oprice="<?=$campainPrice['1486']['old'];?>" productid="1486" Bprice="<?=$campainPrice['1486']['new'];?>" onclick="slider.goToSlide(5);"><?=$Lang->ActivityBook_EBook;?></a>
                        <a class="item-varient" Oprice="<?=$campainPrice['1487']['old'];?>" productid="1487" Bprice="<?=$campainPrice['1487']['new'];?>" onclick="slider.goToSlide(6);"><?=$Lang->TeacherBook;?></a>
                        <a class="item-varient" Oprice="<?=$campainPrice['1488']['old'];?>" productid="1488" Bprice="<?=$campainPrice['1488']['new'];?>" onclick="slider.goToSlide(7);"><?=$Lang->StudentBook_ActivityBook_EBook;?></a>
                    </div>
                    <div class="row">
                            ...
                            <div class="quantity-content">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 quatitly11">
                                        ...
                                        <button class="btn btn-long cart1 floating-left" id="add_to_cart" data-type="book" data-id="1485"><?=$Lang->AddCart;?></button>
                                    </div>
                    ...
                    <div class="mt-2">
                        <div class="row mt-lg-5 mt-sm-0 mt-md-0">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 text-center">
                                <img style="width:88%" class="thumb-item" src="<?=SITE_URL;?>products/books/a1/content/1.jpg">
                            </div>
                        </div>
                        <div class="row mt-lg-5 mt-sm-0 mt-md-0">
                            <div class="col-lg-6 col-md-12 col-sm-12 text-center order-1">
                                <img style="width: 88%" class="thumb-item" src="<?=SITE_URL;?>products/books/a1/content/2.jpg">
                            </div>

                            <div class="col-lg-6 col-md-12 col-sm-12 order-2">
                                <span class="title"><?=$Lang->StudentBook_EBook;?></span>
                                <p><?=$Lang->ArabicFriendsBustanStudent;?></p>
                            </div>
                        </div>
                        <div class="row mt-lg-5 mt-sm-0 mt-md-0">
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <span class="title"><?=$Lang->ActivityBook_EBook;?></span>
                                <p><?=$Lang->ArabicFriendsBustanactivity;?></p>
                            </div>

                            <div class="col-lg-6 col-md-12 col-sm-12 text-center">
                                <img style="width: 88%" class="thumb-item" src="<?=SITE_URL;?>products/books/a1/content/3.jpg">
                            </div>
                        </div>
                        <div class="row mt-lg-5 mt-sm-0 mt-md-0">
                            <div class="col-lg-6 col-md-12 col-sm-12 text-center order-1">
                                <img style="width: 88%" class="thumb-item" src="<?=SITE_URL;?>products/books/a1/content/4.jpg">
                            </div>
                            <div class="col-lg-6 col-md-12 col-sm-12 order-2">
                                <span class="title"><?=$Lang->TeacherBook;?></span>
                                <p><?=$Lang->ArabicFriendsBustanTeacher;?></p>
                            </div>
                        </div>
                    </div>
                </div>
