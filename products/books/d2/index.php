    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="first"><span class="sell-arb floating-left">يباع</span><span class="up-sell-book-title floating-left">هيا إلى الايمان 1</span><span class="floating-left"><?=$Lang->upsalemessage1;?></span></p>
        ...
        <div class="center-piece-series custom">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6">
                    <button class="btn btn-long cart1 floating-left" data-type="book" data-id="1519"><?=$Lang->AddCart;?></button>
                </div>
            </div>
        </div>
    </div>
    <div class="container-fluid mt-2 mb-3 text-left">
        <div class="row">
            <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12 ">
                <div class="card">
                    <div class="demo zoom-box">
                        <ul id="lightSlider">
                            <li data-thumb="<?=SITE_URL;?>products/books/d2/slider/0.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/books/d2/slider/0.jpg" xoriginal="<?=SITE_URL;?>products/books/d2/slider/0.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/books/d2/slider/2.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/books/d2/slider/2.jpg" xoriginal="<?=SITE_URL;?>products/books/d2/slider/2.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/books/d2/slider/3.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/books/d2/slider/3.jpg" xoriginal="<?=SITE_URL;?>products/books/d2/slider/3.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/books/d2/slider/4.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/books/d2/slider/4.jpg" xoriginal="<?=SITE_URL;?>products/books/d2/slider/4.jpg"/></li>
                            <li data-thumb="<?=SITE_URL;?>products/books/d2/slider/1.jpg" class=""><img  class="image-slider1 xzoom" src="<?=SITE_URL;?>products/books/d2/slider/1.jpg" xoriginal="<?=SITE_URL;?>products/books/d2/slider/1.jpg"/></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-lg-7 col-md-12 col-sm-12 col-xs-12 order-2">
                <div class="card">
                    <div class="about">
                        <h4 class="" style="font-family:'Droid Arabic Kufi';text-align: right">هيا إلى الإيمان 1</h4>
                        <span class="font-weight-bold current-price" style="float: right"><label>$</label><label><?=$campainPrice['1519']['new'];?></label></span>
                        <span class="old-price " style="float: right"><label>$</label><label><?=$campainPrice['1519']['old'];?></label></span>
                        <label class="font-weight-bold sale1" style="float: right"><?=$Lang->sale;?></label>
                    </div>
                    <div class="Type-content">
                        <label><?=$Lang->Type;?></label>
                        <a class="item-varient active" Oprice="<?=$campainPrice['1519']['old'];?>" Bprice="<?=$campainPrice['1519']['new'];?>" productid="1519"  onclick="slider.goToSlide(0);"><?=$Lang->StudentBook_EBook;?></a>
                        <a class="item-varient" Oprice="<?=$campainPrice['1520']['old'];?>" Bprice="<?=$campainPrice['1520']['new'];?>" productid="1520"  onclick="slider.goToSlide(4);"><?=$Lang->TeacherBook;?></a>
                    </div>
                    <div class="row">
                            ...
                            <div class="quantity-content">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 quatitly11">
                                        ...
                                        <button class="btn btn-long cart1 floating-left" id="add_to_cart" data-type="book" data-id="1519"><?=$Lang->AddCart;?></button>
                                    </div>
                    ...
                    <div class="mt-2">
                        <div class="row mt-lg-5 mt-sm-0 mt-md-0">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 text-center">
                                <img style="width:88%" class="thumb-item" src="<?=SITE_URL;?>products/books/d2/content/1.jpg">
                            </div>
                        </div>
                        <div class="row mt-lg-5 mt-sm-0 mt-md-0">
                            <div class="col-lg-6 col-md-12 col-sm-12 text-center order-1">
                                <img style="width: 88%" class="thumb-item" src="<?=SITE_URL;?>products/books/d2/content/2.jpg">
                            </div>

                            <div class="col-lg-6 col-md-12 col-sm-12 order-2">
                                <span class="title"><?=$Lang->StudentBook_EBook;?></span>
                                <p><?=$Lang->HeiaElaEmanOneStudent;?></p>
                            </div>
                        </div>
                        <div class="row mt-lg-5 mt-sm-0 mt-md-0">
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <span class="title"><?=$Lang->TeacherBook;?></span>
                                <p><?=$Lang->HeiaElaEmanOneTeacher;?></p>
                            </div>
                            <div class="col-lg-6 col-md-12 col-sm-12">
                                <img style="width: 88%" class="thumb-item" src="<?=SITE_URL;?>products/books/d2/content/3.jpg">
                            </div>
